...
import {
    query as getClientConfigWithoutCheckoutSettingsQuery
} from '../../graphql/getClientConfigWithoutCheckoutSettings.graphql';
import {
    EcomHttpClient
} from './EcomHttpClient';
var SiteStore = /** @class */ (function(_super) {
    ...
    function SiteStore(_a, _b, wixCodeApi, platform, _c, dontShowSideCartOnMobile) {
        ...
        _this.checkoutSettings = {
            delayCaptureEnabled: false
        };
    ...
    SiteStore.prototype.buildUrl = function(relativeUrl, conf) {
        ...
        if (conf.urlParams) {
            ...
            queryParams.push.apply(queryParams, __spreadArray([], __read(Object.keys(params_1).map(function(key) {
                return "".concat(key, "=").concat(params_1[key]);
            })), false));
        }
        ...
        return __awaiter(this, void 0, void 0, function() {
            ...
            return __generator(this, function(_g) {
                switch (_g.label) {
                    ...
                    case 2:
                        return [2 /*return*/ , (_e.sdkLink = (_f.pageId = (_a = (_g.sent())) === null || _a === void 0 ? void 0 : _a.id, _f.type = 'PageLink', _f),
        ...
        return __awaiter(this, void 0, void 0, function() {
            ...
            return __generator(this, function(_a) {
                ...
                if (sdkLink.type === 'DynamicPageLink') {
                    doubleSlashRegex = /\/\//g;
                    pagePath = "/".concat(this.getUrl(sdkLink)).replace(doubleSlashRegex, '/');
                    url = "".concat(this.location.baseUrl).concat(pagePath);
                    return [2 /*return*/ , {
                        sdkLink: sdkLink,
                        url: url,
                    }];
                ...
                switch (_e.label) {
                    ...
                    case 2:
                        ...
                        this.checkoutSettings = {
                            delayCaptureEnabled: Boolean((_a = data.checkoutSettings) === null || _a === void 0 ? void 0 : _a.delayCaptureEnabled)
                        };
