...
import {
    SideCartActions
} from '../SideCartActions/SideCartActions';
import {
    SPECS
} from '../../constants';
var CartActions = /** @class */ (function(_super) {
    ...
    function CartActions(_a) {
        var siteStore = _a.siteStore,
            origin = _a.origin,
            _b = _a.originatedInWorker,
            originatedInWorker = _b === void 0 ? false : _b;
        ...
        _this.cartApi = new CartApi({
            siteStore: siteStore,
            origin: origin,
            locale: siteStore.storeLanguage
        });
            ...
            return __generator(this, function(_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        onSuccess();
                        sideCartActions = new SideCartActions({
                            siteStore: this.siteStore,
                            origin: 'addToCartPublicAPI'
                        });
                        if (!(addToCartAction === AddToCartActionOption.MINI_CART)) return [3 /*break*/ , 5];
                        _d.label = 1;
                    case 1:
                        _d.trys.push([1, 4, , 5]);
                        return [4 /*yield*/ , this.fixToOpenAfterAddToCartIsDone()];
                    case 2:
                        _d.sent();
    ...
    CartActions.prototype.fixToOpenAfterAddToCartIsDone = function() {
        return __awaiter(this, void 0, void 0, function() {
            var shouldSet100msTimeoutAfterAddToCart, shouldSetTimeoutAfterAddToCart;
            return __generator(this, function(_a) {
                shouldSet100msTimeoutAfterAddToCart = this.siteStore.experiments.enabled(SPECS.ShouldSet100msTimeoutAfterAddToCart);
                if (shouldSet100msTimeoutAfterAddToCart) {
                    return [2 /*return*/ , new Promise(function(resolve) {
                        return setTimeout(resolve, 100);
                    })];
                }
                shouldSetTimeoutAfterAddToCart = this.siteStore.experiments.enabled(SPECS.ShouldSetTimeoutAfterAddToCart);
                if (shouldSetTimeoutAfterAddToCart) {
                    return [2 /*return*/ , new Promise(function(resolve) {
                        return setTimeout(resolve, 10);
                    })];
                }
                if (this.siteStore.isPreviewMode()) {
                    return [2 /*return*/ , new Promise(function(resolve) {
                        return setTimeout(resolve, 10);
                    })];
                }
    ...
    CartActions.prototype.publishCart = function(cartSummary, reason, eventOptions) {
        ...
        this.siteStore.pubSubManager.publish(CartEvents.CHANGED, __assign(__assign({}, publishableCart), {
            ...
            eventOptions: __assign(__assign({}, eventOptions), {
            ...
            return __generator(this, function(_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (!!options.silent) return [3 /*break*/ , 3];
    ...
    CartActions.prototype.setDestinationForEstimation = function(data, cartId) {
        return __awaiter(this, void 0, void 0, function() {
            ...
            return __generator(this, function(_a) {
                switch (_a.label) {
                    case 0:
                        return [4 /*yield*/ , this.cartApi.setDestinationForEstimation(data, cartId)];
                    case 1:
                        cartSummary = _a.sent();
                        this.publishCart(cartSummary, 'setDestinationForEstimation', {
                            shouldOpenCart: false
                        });
                        return [2 /*return*/ ];
                }
    ...
    CartActions.prototype.setShippingOption = function(cartId, selectedShippingOption) {
        return __awaiter(this, void 0, void 0, function() {
            ...
            return __generator(this, function(_a) {
                switch (_a.label) {
                    case 0:
                        return [4 /*yield*/ , this.cartApi.setShippingOption(cartId, selectedShippingOption)];
                    case 1:
                        cartSummary = _a.sent();
                        this.publishCart(cartSummary, 'setShippingOption', {
                            shouldOpenCart: false
                        });
                        return [2 /*return*/ ];
                }
    ...
    CartActions.prototype.updateBuyerNote = function(cartId, buyerNote) {
        return __awaiter(this, void 0, void 0, function() {
            ...
            return __generator(this, function(_a) {
                switch (_a.label) {
                    case 0:
                        return [4 /*yield*/ , this.cartApi.updateBuyerNoteMutation(cartId, buyerNote)];
                    case 1:
                        cartSummary = _a.sent();
                        this.publishCart(cartSummary, 'updateBuyerNote', {
                            shouldOpenCart: false
                        });
                        return [2 /*return*/ ];
                }
