...
import {
    MinicartActions
} from '../MiniCartActions/MinicartActions';
import {
    PageMap
    ...
    SideCartActions.prototype.getSideCartLightbox = function() {
        ...
        return __awaiter(this, void 0, void 0, function() {
            ...
            return __generator(this, function(_b) {
                switch (_b.label) {
                    case 0:
                        return [4 /*yield*/ , this.siteStore.wixCodeApi.site.getSiteStructure({
                            includePageId: true
                        })];
                    case 1:
                        siteStructure = _b.sent();
                        return [2 /*return*/ , (_a = siteStructure.lightboxes) === null || _a === void 0 ? void 0 : _a.find(function(lightbox) {
                            return lightbox.tpaPageId === PageMap.SIDE_CART;
                        })];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function() {
            ...
            return __generator(this, function(_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        return [4 /*yield*/ , this.getSideCartLightbox()];
                    case 2:
