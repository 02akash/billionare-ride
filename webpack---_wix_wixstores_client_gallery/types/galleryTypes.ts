...
import type {ICategory, ICategoryListItem} from './category';
...
import {ExternalFilterDTO} from './filters';
import {ISortingOption, ISortingParam} from './sorting';
...
export interface IGalleryStyleParams extends IWixStyleParams {
  ...
  numbers: Partial<{
    ...
    gallery_addToCartButtonPlacement: AddToCartButtonPlacement;
    gallery_addToCartButtonOnImageSidePadding: number;
    gallery_addToCartButtonOnImageBottomPadding: number;
...
export interface ITextsMap extends IMandatoryTextMap {
  ...
  colorSwatchNumChoicesLeftLabel: string;
  colorSwatchNumMoreOptionsAriaLabel: string;
}
...
export interface IPropsInjectedByViewerScript extends ISentryErrorBoundaryPropsInjectedByViewerScript {
  ...
  htmlTags: {
    ...
    categoriesFiltersHtmlTag: HeadingTags;
    categoryPageHeaderHtmlTag: HeadingTags;
  };
  ...
  experiments: {
    ...
    shouldUseGalleryProductItemsLazyLoadingForV3: boolean;
  };
...
export interface ProductsManifest {
  [productId: string]: {
    ...
    productItemsState: ProductItemsState;
  };
}
...
export interface IFilterModel {
  ...
  title: string;
  toDTO: (experiment?: boolean) => IFilterDTO;
  toExternalDTO: () => ExternalFilterDTO | null;
...
export type FilterSource = {[key: string]: string};

export type IFilterOption = IFilterValue & {sources?: FilterSource};
...
export enum NamePriceLayout {
  NameAbovePrice = 1,
  NamePriceSideBySide = 2,
}
...
export enum AddToCartButtonIcon {
  ShoppingBag = 1,
  Plus = 2,
  Cart = 3,
  CartFill = 4,
...
export enum AddToCartButtonPlacement {
  OnImage = 1,
  ProductInfo = 2,
}

export enum PriceAndDiscountLayouts {
  HORIZONTAL_REGULAR_PRICE_BEFORE_DISCOUNT = 0,
  HORIZONTAL_REGULAR_PRICE_AFTER_DISCOUNT = 1,
  VERTICAL_REGULAR_PRICE_BEFORE_DISCOUNT = 2,
  VERTICAL_REGULAR_PRICE_AFTER_DISCOUNT = 3,
}
...
export enum CategoryListHeaderBehavior {
  GO_TO_PARENT = 0,
  DO_NOTHING = 1,
}

export enum LongCategoryListLayout {
  SHOW_ALL = 0,
  LIMIT = 1,
}
