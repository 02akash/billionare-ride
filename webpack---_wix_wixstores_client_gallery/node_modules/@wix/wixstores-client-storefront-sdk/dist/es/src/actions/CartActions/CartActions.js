...
var CartActions = /** @class */ (function(_super) {
    ...
    CartActions.prototype.onAddToCartCompleted = function(cartSummary, addToCartAction, productId, onSuccess) {
        ...
        return __awaiter(this, void 0, void 0, function() {
            var shouldUseOpenSideCartApiInAddToCart, shouldOpenCart, sideCartActions, _a, _b, _c;
            return __generator(this, function(_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        shouldUseOpenSideCartApiInAddToCart = this.siteStore.experiments.enabled(SPECS.ShouldUseOpenSideCartApiInAddToCart);
                        shouldOpenCart = shouldUseOpenSideCartApiInAddToCart ?
                            addToCartAction === AddToCartActionOption.TINY_CART :
                            addToCartAction === AddToCartActionOption.TINY_CART || addToCartAction === AddToCartActionOption.MINI_CART;
                        ...
                        if (!(shouldUseOpenSideCartApiInAddToCart && addToCartAction === AddToCartActionOption.MINI_CART)) return [3 /*break*/ , 5];
                        _d.label = 1;
                    case 1:
                        _d.trys.push([1, 4, , 5]);
