...
export var controllerFactory = function(ControllerConstructor, _a) {
    var _b = _a === void 0 ? {} : _a,
        shouldSkipMultilingual = _b.shouldSkipMultilingual,
        extraParams = _b.extraParams;
    return function(controllerParams) {
        var controller = createController(ControllerConstructor, controllerParams, extraParams);
        return {
            pageReady: function() {
                var _a, _b;
                if ((_a = controllerParams.appData) === null || _a === void 0 ? void 0 : _a.context.siteStore.experiments.enabled(SPECS.NavigateToCartWhenDontShowSideCartOnMobile)) {
                    (_b = controller.onBeforeLoad) === null || _b === void 0 ? void 0 : _b.call(controller, controllerParams);
                }
                return Promise.resolve()
                    .then(handleRTL(controllerParams))
                    .then(function() {
                        return Promise.all(__spreadArray(__spreadArray([], __read((shouldSkipMultilingual ? [] : [handleMultilingual(controllerParams, controller.getFreeTexts())])), false), [
                            controller.init(),
                        ], false));
                    })
