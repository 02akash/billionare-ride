...
import {
    queries as cartQueriesOld
} from '../../graphql/cart.graphql.old';
import {
...
var CartApi = /** @class */ (function(_super) {
    ...
    CartApi.prototype.getCartQueries = function() {
        return this.siteStore.experiments.enabled(SPECS.AddPageUrlToCartQuery) ? cartQueries : cartQueriesOld;
    };
