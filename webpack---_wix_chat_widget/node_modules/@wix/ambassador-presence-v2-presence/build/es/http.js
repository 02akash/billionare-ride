...
var _listPresencesRequest = {};
var _listPresencesResponse = {
    presences: '_presence'
};
var _payload = {
...
/**
 * Returns a snapshot of presences
 * Returns up to 100 presence entities
 */
export function listPresences(payload) {
    return function __listPresences(_a) {
        var host = _a.host;
        var toJSON = serializer(_listPresencesRequest, {}).toJSON;
        var fromJSON = serializer(_listPresencesResponse, {
            _payload: _payload,
            _presence: _presence,
        }).fromJSON;
        var serializedData = toJSON(payload);
        var metadata = {
            method: 'GET',
            url: resolveComWixpressPresenceApiV2PresenceServiceUrl({
                protoPath: '/api/v2/presences/list/{scope}',
                data: serializedData,
                host: host,
            }),
            params: toURLSearchParams(serializedData),
