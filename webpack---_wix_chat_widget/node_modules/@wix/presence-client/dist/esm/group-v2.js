...
var GroupV2 = /** @class */ (function() {
    function GroupV2(_a) {
        ...
        var getPresenceConnection = _a.getPresenceConnection,
            ...
            _b = _a.getInitialState,
            getInitialState = _b === void 0 ? function() {
                return ({});
            } : _b,
            ...
            return __awaiter(_this, void 0, void 0, function() {
                return __generator(this, function(_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, , 2, 3]);
                            return [4 /*yield*/ , this.onActiveFn()];
                        case 1:
                            _a.sent();
                            return [3 /*break*/ , 3];
                        case 2:
        ...
        this.onSubscribe = function() {
            return __awaiter(_this, void 0, void 0, function() {
                return __generator(this, function(_a) {
                    switch (_a.label) {
                        case 0:
                            return [4 /*yield*/ , this.createState(this.getInitialState())];
                        case 1:
                            _a.sent();
        ...
        this.scope = this.convertScope(scope);
    ...
    GroupV2.prototype.convertScope = function(scope) {
        switch (scope) {
            case Scope.EDITOR_X:
                return ScopeV2.EDITOR_X;
            case Scope.VIEWER:
                return ScopeV2.VIEWER;
            default:
                return ScopeV2.UNDEFINED;
        }
    };
    return GroupV2;
}());
