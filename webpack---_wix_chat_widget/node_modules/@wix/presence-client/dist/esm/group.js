...
var Group = /** @class */ (function() {
        ...
        this.watchGroup = function() {
            return __awaiter(_this, void 0, void 0, function() {
                ...
                return __generator(this, function(_a) {
                    switch (_a.label) {
                        case 0:
                            if (!this.shuoldWatchGroup) return [3 /*break*/ , 2];
                            return [4 /*yield*/ , this.presenceClient()];
                        case 1:
                            (_a.sent())
                            .watch({
                                    scope: this.scope
                            ...
                            _a.label = 2;
                        case 2:
                            if (this.watchGroupTimer) {
                                clearTimeout(this.watchGroupTimer);
                            }
                            this.watchGroupTimer = setTimeout(function() {
    ...
    Group.prototype.initPresenceApi = function() {
        return __awaiter(this, void 0, void 0, function() {
            var PresenceServiceInstance;
            return __generator(this, function(_a) {
                switch (_a.label) {
                    case 0:
                        if (!!this.presenceApi) return [3 /*break*/ , 2];
                        return [4 /*yield*/ ,
                            import ('@wix/ambassador-presence-service/http')
                        ];
                    case 1:
                        PresenceServiceInstance = (_a.sent()).PresenceService;
                        this.presenceApi = PresenceServiceInstance(PRESENCE_URL, {
            ...
            return __generator(this, function(_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/ , this.presenceClient()];
                    case 1:
                        return [4 /*yield*/ , (_a.sent()).setData({
            ...
            return __generator(this, function(_a) {
                switch (_a.label) {
                    case 0:
                        return [4 /*yield*/ , this.presenceClient()];
                    case 1:
                        return [4 /*yield*/ , (_a.sent()).resetScope({
                            scope: this.scope,
                        })];
                    case 2:
                        _a.sent();
    ...
    Group.prototype.presenceClient = function() {
        return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(_a) {
                switch (_a.label) {
                    case 0:
                        return [4 /*yield*/ , this.initPresenceApi()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/ , this.presenceApi({
