...
var VirtualSocket = /** @class */ (function(_super) {
    ...
    VirtualSocket.prototype.listen = function() {
        this.socketListeners = [
            (0, on_1.default)(this.duplexer, 'open', this.onConnect.bind(this)),
            (0, on_1.default)(this.duplexer, 'packet', this.onPacket.bind(this)),
            (0, on_1.default)(this.duplexer, 'close', this.onClose.bind(this)),
            (0, on_1.default)(this.duplexer.connection, 'connect_error', this.onConnectError.bind(this)),
        ];
    };
