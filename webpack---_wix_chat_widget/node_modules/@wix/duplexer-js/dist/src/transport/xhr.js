...
var Xhr = /** @class */ (function(_super) {
    ...
    function Xhr(baseUrl, instanceUpdater, siteRevision, keepAlive) {
        ...
        _this.baseUrl = (0, utils_1.omitEndingSlashIfExists)(_this.baseUrl);
        return _this;
    }
    ...
    Xhr.prototype.write = function(packet, _a) {
        var _b = _a === void 0 ? {} : _a,
            _c = _b.affectState,
            affectState = _c === void 0 ? true : _c;
        return __awaiter(this, void 0, void 0, function() {
            var cancelToken, url, data, e_1;
            return __generator(this, function(_d) {
                switch (_d.label) {
                    case 0:
                        _d.trys.push([0, 3, , 4]);
                        cancelToken = (0, cancel_token_1.createCancelTokenSource)();
                        this.commandsCancelTokens.push(cancelToken);
                        return [4 /*yield*/ , this.buildUrl('xhr-command')];
                    case 1:
                        url = _d.sent();
                        return [4 /*yield*/ , (0, request_1.post)(url, packet, {
                            cancelToken: cancelToken.token,
                            headers: (0, http_1.maybeHeaders)(this.instanceUpdater),
                        })];
                    case 2:
                        data = (_d.sent()).data;
    ...
    Xhr.prototype.poll = function() {
        return __awaiter(this, void 0, void 0, function() {
            ...
            return __generator(this, function(_a) {
                switch (_a.label) {
                    case 0:
                        return [4 /*yield*/ , this.buildUrl('xhr')];
                    case 1:
                        url = _a.sent();
                        this.pollCancelToken = (0, cancel_token_1.createCancelTokenSource)();
                        pollReq = (0, request_1.post)(url, this.payload, {
                    ...
                    case 2:
                        _a.trys.push([2, 4, , 5]);
                        return [4 /*yield*/ , (0, http_1.longHttp)(pollReq)];
                    case 3:
                        res = _a.sent();
                        if (res.data) {
            ...
            return __generator(this, function(_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        urlWithParams = (0, params_1.withParams)(url, params);
                        return [2 /*return*/ , "".concat(this.baseUrl, "/").concat(urlWithParams)];
                }
            });
        });
    };
    Xhr.prototype.closeOnTransportFailure = function(e) {
        ...
        var err = this.transportError({
            status: status,
            message: e.message,
            recoverable: (0, unrecoverable_1.isRecoverableCode)(status),
        });
