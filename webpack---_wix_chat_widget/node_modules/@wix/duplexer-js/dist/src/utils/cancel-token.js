...
exports.createCancelTokenSource = exports.isCancel = void 0;
var deferred_1 = __importDefault(require("./deferred"));
var CANCEL_OP = {};

function isCancel(maybeCancelOp) {
...
function createCancelTokenSource() {
    ...
    return {
        cancel: function() {
            return deferred.resolve(CANCEL_OP);
        },
        token: {
...
exports.createCancelTokenSource = createCancelTokenSource;
