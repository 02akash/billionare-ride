    ...
    return function() {
        ...
        return function() {
            ...
            var s = {
                ...
                contents: "aGHwBE",
                text: "areOb6",
                wixLogoWrapper: "dTTUA9",
                wixLogo: "_4i7Zy",
                dot: "o4sLYL",
                com: "uJDaUS",
                button: "O0tKs2"
            };
            const i = "bannerOverlay",
                l = "bannerLogo";
            var c = "{Wix}";
            const u = e => e.bannerText.indexOf(c) >= 0;
            ...
            function d(e) {
                ...
                if ("string" == typeof e || "number" == typeof e) r += e;
                    ...
                    if (Array.isArray(e))
                        for (t = 0; t < e.length; t++) e[t] && (a = d(e[t])) && (r && (r += " "), r += a);
                    else
                        for (t in e) e[t] && (r && (r += " "), r += t);
                return r
            }
            var p = function() {
                for (var e, t, a = 0, r = ""; a < arguments.length;)(e = arguments[a++]) && (t = d(e)) && (r && (r += " "), r += t);
                return r
            };
            const f = e => Object.entries(e).reduce(((e, [t, a]) => (t.includes("data-") && (e[t] = a), e)), {});
            const m = 13,
                b = 27;
            ...
            const v = x(32),
                ...
                E = (e, r) => {
                    ...
                    return void 0 !== o ? a.createElement("a", t()({}, f(e), {
                        "data-testid": b,
                        "data-popupid": u,
                        "data-anchor": d,
            ...
            var B = e => {
                const {
                    ...
                    textAfterLogo: b,
                    direction: x
                } = e, v = p(...s.map((e => u[e])), u.desktopTop, "has-custom-focus");
                return a.createElement("div", t()({
                    ...
                    "data-hook": "freemium-text",
                    className: u.text
                }, m, c, b), a.createElement("span", {
                    "data-hook": "freemium-button",
                    className: u.button + " " + u[x]
                }, d))))
            };
            const N = {
                FreemiumBannerDesktop: {
                    component: e => {
                        ...
                        return a.createElement(B, t()({}, e, {
                            ...
                            "data-testid": l,
                            className: s.wixLogoWrapper
                        }, a.createElement("div", null, a.createElement(n, {
                            rootClass: s.wixLogo,
                            dotClass: s.dot
                        })), a.createElement("div", {
                            className: s.com
...
//# sourceMappingURL=https://static.parastorage.com/services/editor-elements-library/dist/thunderbolt/rb_wixui.thunderbolt[FreemiumBannerDesktop].ced5ac22.bundle.min.js.map