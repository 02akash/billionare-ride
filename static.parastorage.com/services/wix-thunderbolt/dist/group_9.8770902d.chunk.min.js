        ...
        41253: function(e, t, i) {
            ...
            class M {
                ...
                rejectAuthenticationRequest() {
                    this.requestAuthenticationRejectInstance && (this.requestAuthenticationRejectInstance(D.qd.CANCELED), this.reset())
                }
            ...
            const ke = (e, t, i) => {
                ...
                Ue = (0, a.Og)([(0, a.KT)(o.YG, _.UU), (0, a.KT)(o._K, _.UU), (0, a.KT)(o.wk, _.UU), (0, a.KT)(o.AF, _.UU), s.F, n.Ht, n.TQ, S.i$, r.Ji, r.eZ, n.dn, n.RV, b.Ix, (0, a.lq)(f.j), b.$1, c.F, l.O$, (0, a.lq)(E.KK), (0, a.lq)(C.i), u.t7, d.n, (0, a.lq)(g.Z), (0, a.lq)(R.j), (0, a.lq)(T.U), (0, a.lq)(Le.gB)], ((e, t, i, a, o, s, n, r, c, l, u, d, g, S, b, f, E, C, w = {
                    trackEvent: () => 0
                }, _, N, A, T, R, k) => {
                    const U = (0, m.o)(),
                        {
                    ...
                    const J = "22bef345-3c5b-4c18-b782-74d4085112ff",
                        Y = r.getUserSession(),
                        Ce = () => r.getAppInstanceByAppDefId(J) || "",
                        we = () => (0, O.YA)(r),
                        Pe = N["specs.thunderbolt.deprecateAppId"],
                        ye = N["specs.ident.usePlatformizedSMAuth"],
                        {
                            smSettings: De,
                            tpaAppDefinitionIds: _e,
                        ...
                        Ve = n.requestUrl,
                        Be = n.viewMode,
                        Fe = n.anywhereConfig ? .siteId ? ? Ue,
                        qe = n.anywhereConfig ? .revision ? ? Me,
                        We = -1 !== D.UG.findIndex((e => d ? .navigator ? .userAgent ? .includes(e))),
                        $e = !We,
                        xe = !We,
                        He = `/_api/wix-sm-webapp/tokens/verify/${Te}/${Fe}`,
                        Ge = `${Le.replace(/\/$/,"")}/api/wix-sm/v1/authorize/${Fe}/pages`,
                        je = `/_api/wix-sm-webapp/tokens/logout/${Te}`,
                        Ke = `/_api/wix-sm-webapp/member/changePasswordWithMailToken?metaSiteId=${Te}&collectionId=${x}`,
                        Je = "/_api/iam/state-machine-service",
                        Ye = De.smFirstDialogLogin ? "login" : "signup",
                        {
                            socialLoginFacebookEnabled: ze,
                            socialLoginGoogleEnabled: Xe,
                            termsOfUse: Qe,
                            privacyPolicy: Ze,
                            codeOfConduct: et,
                            customSignUpPageId: tt,
                            customSignInPageId: it
                        } = De,
                        {
                            privacyNoteType: at,
                            joinCommunityCheckedByDefault: ot
                        } = (e => ({
                            privacyNoteType: z(e),
                    ...
                    let {
                        smToken: st
                    } = e, nt = {}, rt = q, ct = null, lt = !1;
                    const ut = e => {
                            ct = e
                        },
                        dt = () => ({
                            registerToAppDidMount: ut,
                            shouldWaitForAppDidMount: !lt
                        }),
                        gt = async () => {
                            if (N["specs.thunderbolt.getMemberDetailsFromMembersNg"]) {
                                const {
                                    member: e
                                } = await bt("/_api/members/v1/members/my?fieldsets=FULL", {
                                    headers: {
                                        authorization: r.getAppInstanceByAppDefId(J) ? ? ""
                                    }
                                }), {
                                    role: t
                                } = await (0, O.hv)((() => bt(`/api/wix-sm/v1/members/${e?.id}/role`, {
                                    headers: {
                                        authorization: r.getAppInstanceByAppDefId(J) ? ? ""
                                    }
                                })), (() => ({
                            ...
                            const e = `/_api/wix-sm-webapp/member/${st}?collectionId=${x}&metaSiteId=${Te}`,
                                {
                                    payload: t
                                } = await bt(e);
                            return (0, O.Yv)(t)
                        ...
                        ht = L({
                            ...
                            businessLogger: f,
                            wixBiSession: E,
                            viewMode: Be ? .toUpperCase(),
                            language: u
                        });
                    ht.siteMembersFeatureLoaded();
                    const St = {},
                        bt = (0, O.I5)(o, {
                        ...
                        ft = (0, ee.u)({
                            isSSR: !1,
                            ...N["specs.thunderbolt.siteMembersMultilingualLanguage"] ? {
                                multilingualOptions: {
                        ...
                        Ct = ((e, t, i, a, o) => new v(e, t, i, a, o))(c, l, S, d, T),
                        wt = new URL(Ve).searchParams,
                        Pt = {};
                    wt.forEach(((e, t) => {
                        Pt[t] = e
                    }));
                    const yt = (e => {
                            ...
                            const i = P().tryParse(null == t ? void 0 : t.headlessExternalUrls, {}) ? ? {};
                        ...
                        vt = (0, O.Ed)(d, U),
                        Nt = new M(C, (async () => {
                            const e = await Dt.getCaptchaSettings();
                            (e.invisible.login || e.invisible.signup) && vt.hideCaptchaBadge()
                        })),
                        At = R ? .getBsi(),
                        It = At ? At.split("|")[0] : "00000000-0000-0000-0000-000000000000",
                        Ot = e => {
                        ...
                        Tt = {
                            ...
                            async handleSocialLoginResponse(e, t, i = !1) {
                                const a = D.UI[t] ? ? t;
                                s.interactionStarted(D.sH.SOCIAL_APP_LOGIN), s.interactionEnded(D.sH.SOCIAL_APP_LOGIN), s.interactionEnded(D.sH.SOCIAL_APP_LOGIN_WITH_VENDOR(a)), w.trackEvent((0, D.SU)(D.WW.ACTIONS.LOGIN.SUBMIT, a)), N["specs.thunderbolt.useNewPostLoginRedirect"] || (0, O._y)(d, Ve, {});
                                const o = await Tt.handleIAMLoginResponseV1(e, i);
                                return w.trackEvent((0, D.SU)(D.WW.ACTIONS.LOGIN.SUCCESS, a)), o
                            },
                            async handleIAMLoginResponseV1(e, t = !1) {
                                if (e.identity ? .status ? .name === Ee.EH.PENDING) {
                                    if (ye) {
                                        if (Ne[D.$m.ADMIN_APPROVAL]) throw Nt.rejectAuthenticationRequest(), await g.navigate(D.m2[D.$m.ADMIN_APPROVAL]), new Error(D.qd.CANCELED)
                                    }
                                    return Tt.showAdminApprovalDialog(e.identity.email ? .address ? ? "")
                                }
                                const i = (0, O.N3)(e),
                                    a = e.sessionToken,
                                ...
                                if ((0, O._y)(d, Ve, {
                                        sessionToken: a
                                    }) && N["specs.thunderbolt.useNewPostLoginRedirect"]) return (0, O.yw)();
                                const s = await Tt.applySessionToken(a, i, t && !o);
                                return {
                                    sessionToken: a,
                                    member: i,
                                    ...t ? {
                            ...
                            async promptLogin(e = {}, t = Nt.config ? .isCloseable ? ? !0, i = Nt.config ? .returnPages ? ? !1) {
                                const {
                                    mode: a,
                                    modal: o
                                } = e, s = "login" === (a ? ? Ye), n = o ? "popup" : "fullscreen";
                                return j ? (await Tt.showNotificationDialog(Ie.templateNotificationTitle, Ie.templateNotificationMessage, Ie.containerOk), Promise.reject(D.qd.CANCELED)) : (vt.loadScript(u.userLanguage, D.c8), s ? Tt.showLoginDialog({
                                    isCloseable: t,
                                    displayMode: n,
                                    returnPages: i
                                }) : Tt.showSignUpDialog({
                            ...
                            promptForgotPassword(e = !0) {
                                return new Promise(((t, i) => {
                                    Nt.assignRequestAuthenticationPromise(t, i);
                                    const a = {
                                            isCloseable: e,
                                        ...
                                        o = {
                                            async onCloseDialogCallback() {
                                                (0, O.Fy)(Ve, d), ht.closingDialog("RequestResetPassword"), Ct.hideDialog(), Nt.rejectAuthenticationRequest()
                                            },
                                            onSubmitCallback(e) {
                                                return Tt.sendForgotPasswordMail(e).then((async () => {
                                                    const e = () => {
                                                        (0, O.Fy)(Ve, d), Nt.resolveAuthenticationRequest(), i(D.qd.CANCELED)
                                                    };
                                                    Tt.showNotificationDialog(Ie.resetPasswordCheckEmailTitle, Ie.resetPasswordCheckEmailText, Ie.resetPasswordOk, e, e)
                                                }))
                                            }
                                        },
                                        s = dt();
                                    if (ye) {
                                        const e = Ne[D.$m.FORGOT_PASSWORD];
                                        if (e) return C ? .open(e).then((() => {
                                            Ct.hideDialog(!0)
                                        }))
                                    }
                                    Ct.displayDialog("RequestPasswordResetDialog", a, o, s)
                                }))
                            },
                            ...
                            async requestAuthorizedPages(e = {}) {
                                if (st) {
                                    return {
                                        success: !0,
                                        pages: await Tt.authorizeMemberPagesBySignedInstance(Ce())
                                    }
                                }
                                try {
                                    const t = !F;
                                    ...
                                    const i = await Tt.promptLogin(e, t, !0);
                                    return Nt.reset(), {
                                        success: !0,
                                        pages: i.pages
                                    }
                            ...
                            async applySessionToken(e, t, i = !1) {
                                ...
                                const o = await ft.request(function(e) {
                                    var t = (0, G.d)(Se, {}),
                                        i = t.toJSON,
                                        a = t.fromJSON,
                                        o = (0, G.d)(be, {}).fromJSON;
                                ...
                                var n;
                                if (s.interactionEnded(D.sH.VERIFY_TOKEN), await r.loadNewSession({
                                        reason: "memberLogin"
                                    }), st = r.getSmToken(), rt = e, nt = t ? ? await Tt.getMemberDetails(), await (n = nt, Promise.all(Object.entries(mt).map((async ([e, t]) => {
                                        try {
                                            if ("$$$timeout$$$" === await Promise.race([t(n), (0, O.yy)(3e3).then((() => "$$$timeout$$$"))])) throw new Error(`callback ${e} timed out`)
                                        } catch (e) {
                                            s.captureError(e, {
                                                tags: {
                                                    feature: "site-members"
                            ...
                            async getMemberDetails(e = !1) {
                                return nt.id && !e ? nt : st ? (nt = await gt(), a.export({
                                    memberDetails: nt
                                }), e && await (t = nt, Promise.all(Object.values(St).map((async e => {
                                    try {
                                        await e(t)
                                    } catch (e) {
                                        s.captureError(e, {
                            ...
                            async sendForgotPasswordMail(e) {
                                ...
                                await bt("/_api/iam/recovery/v1/send-email", {
                                    headers: o,
                                    method: "POST",
                                    body: a
                            ...
                            async sendSetPasswordEmail(e, t) {
                                const i = await bt("/_api/wix-sm-webapp/members/v1/auth/members/send-set-password-email", {
                                    method: "POST",
                                    headers: {
                                        "Content-Type": "application/json",
                                        authorization: Ce()
                            ...
                            async changePassword(e, t) {
                                const a = encodeURIComponent(e),
                                    ...
                                    s = o.startsWith(D.Zq),
                                    n = s ? "/_api/iam/recovery/v1/recover" : Ke,
                                    r = s ? JSON.stringify({
                                        password: e,
                                        recovery_token: o
                            ...
                            async resendEmailVerification(e) {
                                await bt(`/_api/wix-sm-webapp/tokens/email/resend/${e}`)
                            },
                            async logout(e) {
                                if (!st) return !1;
                                if (N["specs.thunderbolt.logoutOnIAM"] ? await ft.request(function(e) {
                                        var t = (0, G.d)(ue, {}),
                                            i = t.toJSON,
                                            a = t.fromJSON,
                                            o = (0, G.d)(ge, {}).fromJSON;
                                        ...
                                        w.trackEvent((0, D.SU)(D.WW.ACTIONS.LOGOUT.FAIL))
                                    })) : await bt(je, {
                                        method: "POST"
                                    }).catch((() => {
                                        w.trackEvent((0, D.SU)(D.WW.ACTIONS.LOGOUT.FAIL))
                                    })), await Promise.all(Object.entries(pt).map((async ([e, t]) => {
                                        try {
                                ...
                                const t = {
                                    ...
                                    a = {
                                        onCloseDialogCallback() {
                                            (0, O.Fy)(Ve, d), ht.closingDialog("WelcomeDialog");
                                            const e = new URL(Ve).hostname,
                                                t = 0 === e.indexOf("www") ? e.substr(3) : e;
                                            ke("sm_ef", "/", t), K = "", Ct.hideDialog(), g.navigate(i.href)
                                        },
                                        onSubmitCallback() {
                                            const e = new URL(Ve).hostname,
                                                t = 0 === e.indexOf("www") ? e.substr(3) : e;
                                            ke("sm_ef", "/", t), K = "", Ct.hideDialog(), Oe && g.navigate("./account/my-account"), g.navigate(i.href)
                                        }
                                    };
                                s.interactionStarted(D.sH.WELCOME_DIALOG), s.interactionEnded(D.sH.WELCOME_DIALOG), Ct.displayDialog("WelcomeDialog", t, a)
                            },
                            async showNoPermissionsToPageDialog(e) {
                                if (ye) {
                                    if (Ne[D.$m.NO_PERMISSION]) return void g.navigate(D.m2[D.$m.NO_PERMISSION])
                                }
                                const t = {
                                    onCloseDialogCallback() {
                                        (0, O.Fy)(Ve, d), Ct.hideDialog(), e && e()
                                    },
                                    onSwitchAccountLinkClick() {
                                        Tt.logout()
                                    }
                                };
                                Ct.displayDialog("NoPermissionsToPageDialog", {
                                    translations: Ie
                                }, t)
                            },
                            async showResetPasswordDialog(e) {
                                ...
                                if (ye) {
                                    if (Ne[D.$m.RESET_PASSWORD]) {
                                        i.update((t => ({ ...t,
                                            resetPasswordToken: e
                                        })));
                                        const a = t();
                                        return d ? .history.replaceState({}, "", a.href), await g.navigate(D.m2[D.$m.RESET_PASSWORD])
                                    }
                                }
                                const a = {
                                        isCloseable: !0,
                                        isTermsOfUseNeeded: !(!Qe ? .enabled || !Ae.termsOfUse),
                                        isPrivacyPolicyNeeded: !(!Ze ? .enabled || !Ae.privacyPolicy),
                                    ...
                                    o = {
                                        onCloseDialogCallback() {
                                            (0, O.Fy)(Ve, d), ht.closingDialog("ResetPasswordDialog");
                                            const e = t();
                                            Ct.hideDialog(), g.navigate(e.href)
                                        },
                                        async onSubmitCallback(i) {
                                            try {
                                                await Tt.changePassword(i, e), Tt.showNotificationDialog(Ie.resetPasswordSuccessTitle, "", Ie.containerOk, (async () => {
                                                    if (e.startsWith(D.Zq)) {
                                                        const e = new URL(Ve).searchParams.get("redirectUrl");
                                                        if (e) return d ? .location.replace(e)
                                                    }
                                                    const i = t();
                                                    await Tt.showLoginDialog(), g.navigate(i.href)
                                                }))
                                            } catch (e) {
                                                const t = (0, O.E2)(e).toString();
                                                if (t !== D.OQ.RESET_PASSWORD_TOKEN_EXPIRED && t !== D.OQ.NEW_RESET_PASSWORD_TOKEN_EXPIRED) throw e;
                                                if (ye) {
                                                    if (Ne[D.$m.EXPIRED_TOKEN]) return void await g.navigate(D.m2[D.$m.EXPIRED_TOKEN])
                                                }
                                                Tt.showNotificationDialog(Ie.passwordHasExpiredTitle, Ie.passwordHasExpiredText, Ie.passwordHasExpiredOk, (() => Tt.promptForgotPassword(a.isCloseable).then((() => {
                                                    const e = b.getParsedUrl();
                                                    g.navigate(e.href)
                                                }))))
                                            }
                                ...
                                Ct.displayDialog("ResetPasswordDialog", a, o, dt())
                            },
                            async showLoggedInResetPasswordDialog() {
                                const e = {
                                    ...
                                    t = {
                                        onCloseDialogCallback() {
                                            ht.closingDialog("LoggedInResetPasswordDialog"), Ct.hideDialog()
                                        },
                                        async onSubmitCallback() {}
                                    };
                                Ct.displayDialog("LoggedInResetPasswordDialog", e, t, dt())
                            },
                            async showLoginDialog(e = {}, t) {
                                const {
                                    ...
                                    returnPages: !1,
                                    ...e
                                }, n = await Dt.getCaptchaSettings();
                                return vt.setCaptchaBadgeVisibility(n.invisible.login), it && C ? .isLightbox(it) ? Tt.showCustomAuthenticationDialog(it, i) : new Promise((async (e, r) => {
                                    Nt.assignRequestAuthenticationPromise(e, r);
                                    const c = "Enabled" === N["specs.ShouldForceCaptchaVerificationOnLoginSpec"] || n.visible.login,
                                        [l, g] = (0, y.partition)(await Tt.getConnections(), {
                                            appDefId: D.ch.PASSWORD
                                        }),
                                        m = await Tt.getLoginUrl(),
                                        p = {
                                            bsi: It,
                                            displayMode: o,
                                            ...
                                            isSocialAuthSupported: $e,
                                            serverError: t,
                                            reportBi: f.reportBi,
                                            translations: Ie,
                                            externalBaseUrl: Tt.getExternalBaseUrl(),
                                            headlessRedirectUrl: m
                                        },
                                        S = {
                                            onCloseDialogCallback() {
                                                (0, O.Fy)(Ve, d), Ct.hideDialog(), ht.closingDialog("MemberLoginDialog", o), Nt.rejectAuthenticationRequest()
                                            },
                                            submit(t, a, n) {
                                                return s.interactionStarted(D.sH.DEFAULT_LOGIN), ht.emailAuthSubmitClicked("MemberLoginDialog", o), Tt.login(t, a, n, i, void 0, !0).then((t => {
                                                    s.interactionEnded(D.sH.DEFAULT_LOGIN), Ct.hideDialog(), e(t)
                                                })).catch((e => {
                                                    throw (0, O.qi)(e) && s.interactionEnded(D.sH.DEFAULT_LOGIN), e
                                                }))
                                            },
                                            onForgetYourPasswordClick() {
                                                Tt.promptForgotPassword(a)
                                            },
                                            onSwitchDialogLinkClick() {
                                                Tt.showSignUpDialog({
                                                    ...
                                                    Nt.rejectAuthenticationRequest()
                                                }))
                                            },
                                            onBackendSocialLogin(t, a) {
                                                return Tt.handleSocialLoginResponse(t, a, i).then((t => {
                                                    Ct.hideDialog(), e(t)
                                                }))
                                            },
                                            getHostReadyPayload: () => ({
                                            ...
                                            reportSocialAuthStarted: Ot
                                        };
                                    ht.loginOrSignUpDialogLoaded("MemberLoginDialog", o), await Ct.displayDialog("MemberLoginDialog", p, S, dt()), Tt.closeCustomAuthenticationDialogs(!0)
                                }))
                            },
                            async showSignUpDialog(e = {}, t) {
                                ...
                                if (vt.setCaptchaBadgeVisibility(n.invisible.signup), tt && C ? .isLightbox(tt)) return Tt.showCustomAuthenticationDialog(tt, i);
                                const r = "Enabled" !== N["specs.ShouldPassCaptchaVerificationOnSignupSpec"] && "Enabled" === N["specs.ShouldForceCaptchaVerificationOnSignupSpec"];
                                return new Promise((async (e, c) => {
                                    const l = r || n.visible.signup && "Enabled" !== N["specs.ShouldPassCaptchaVerificationOnSignupSpec"],
                                        [g, m] = (0, y.partition)(await Tt.getConnections(), {
                                            appDefId: D.ch.PASSWORD
                                        }),
                                        p = await Tt.getLoginUrl();
                                    Nt.assignRequestAuthenticationPromise(e, c);
                                    const S = {
                                            bsi: It,
                                            displayMode: o,
                                            language: u.userLanguage,
                                            ...
                                            idps: m,
                                            isCommunityInstalled: await Et.canHavePublicMembers(),
                                            privacyNoteType: at,
                                            joinCommunityCheckedByDefault: ot,
                                            isTermsOfUseNeeded: !(!Qe ? .enabled || !Ae.termsOfUse),
                                            isPrivacyPolicyNeeded: !(!Ze ? .enabled || !Ae.privacyPolicy),
                                            isCodeOfConductNeeded: !(!et ? .enabled || !Ae.codeOfConduct),
                                        ...
                                        b = {
                                            onCloseDialogCallback() {
                                                (0, O.Fy)(Ve, d), Ct.hideDialog(), ht.closingDialog("SignUpDialog", o), Nt.rejectAuthenticationRequest()
                                            },
                                            async submit(t, a, n) {
                                                let r;
                                                ...
                                                return s.interactionStarted(D.sH.DEFAULT_SIGNUP), ht.emailAuthSubmitClicked("SignUpDialog", o), Tt.register(t, a, void 0, r, !0, i, c, void 0).then((t => {
                                                    ...
                                                    throw (0, O.NU)(e) && s.interactionEnded(D.sH.DEFAULT_SIGNUP), e
                                                }))
                                            },
                                            onSwitchDialogLinkClick() {
                                                Tt.showLoginDialog({
                                    ...
                                    ht.loginOrSignUpDialogLoaded("SignUpDialog", o), await Ct.displayDialog("SignUpDialog", S, b, dt()), Tt.closeCustomAuthenticationDialogs(!0)
                                }))
                            },
                            ...
                            async showNotificationDialog(e, t, i, a = (() => 0), o = (() => 0)) {
                                const s = {
                                    ...
                                    n = {
                                        onCloseDialogCallback() {
                                            (0, O.Fy)(Ve, d), ht.closingDialog("NotificationDialog"), Ct.hideDialog(), o()
                                        },
                                        onOkButtonClick() {
                                            Ct.hideDialog(), a()
                                        }
                            ...
                            async showConfirmationEmailDialog(e, t = !0) {
                                return new Promise(((i, a) => {
                                    const o = {
                                        ...
                                        s = {
                                            onCloseDialogCallback() {
                                                (0, O.Fy)(Ve, d), ht.closingDialog("ConfirmationEmailDialog"), Ct.hideDialog(), Nt.rejectAuthenticationRequest(), a(D.qd.CANCELED)
                                            },
                                            async onResendConfirmationEmail() {
                                                await Tt.resendEmailVerification(e), await Tt.showConfirmationEmailDialog(e, !1).catch(a)
                                            }
                                        };
                            ...
                            async showAdminApprovalDialog(e) {
                                return new Promise(((t, i) => {
                                    const a = () => {
                                        ...
                                        }), Nt.rejectAuthenticationRequest(), i(D.qd.CANCELED), Tt.closeCustomAuthenticationDialogs(!1)
                                    };
                                    Tt.showNotificationDialog("", `${Ie.applySuccess1} ${Ie.applySuccess2}`.replace("{0}", e), Ie.containerOk, a, a)
                                }))
                            },
                            async showCustomAuthenticationDialog(e, t = !1) {
                                if (!C) throw new Error("popup unavailable");
                                return new Promise((async (i, a) => {
                                    Nt.assignRequestAuthenticationPromise(i, a);
                                    const o = Tt.registerToUserLogin((async () => {
                                        Nt.resolveAuthenticationRequest({
                                            member: nt,
                                            sessionToken: rt,
                                            ...t ? {
                                                pages: await Tt.authorizeMemberPagesBySignedInstance(Ce())
                                            } : {}
                                        }), Tt.unRegisterToUserLogin(o), C.getCurrentLightboxId() === e && C.close()
                                    }), "customAuthCbId");
                                    await Nt.openPopupPage(e, (() => {
                                        Tt.unRegisterToUserLogin(o)
                                    })), Ct.hideDialog()
                                }))
                            },
                            async closeCustomAuthenticationDialogs(e = !1) {
                                const t = C ? .getCurrentLightboxId();
                                t && [tt, it].includes(t) && (e && Nt.preventCustomPopupCloseCallback(), await C.close(), Nt.allowCustomPopupCloseCallback())
                            },
                            getForgotPasswordToken() {
                                return new URL((0, p.fU)(d) ? Ve : d.location.href).searchParams.get("forgotPasswordToken")
                            },
                            ...
                            async resendVerificationCodeEmail() {
                                ht.siteMembersEmailConfirmationOnResendCodeClick();
                                const e = i.get().emailConfirmationStateToken,
                                    t = await bt(`${Je}/v1/proceed`, {
                                        method: "POST",
                                        headers: {
                                            "Content-Type": "application/json",
                                            authorization: Ce()
                            ...
                            async showVerificationCodeDialog(e, t = !0) {
                                return new Promise((async (i, a) => {
                                    s.interactionStarted(D.sH.VERIFICATION_CODE), ht.siteMembersEmailConfirmationNewMembersModalLoad(), Nt.assignRequestAuthenticationPromise(i, a);
                                    const o = {
                                            language: u.userLanguage,
                                            directionByLanguage: u.directionByLanguage,
                                            isCloseable: Nt.config ? .isCloseable ? ? !0,
                                            ...
                                            isVerificationCodeDialogNewLogic: N["specs.thunderbolt.verificationCodeDialogNewLogic"]
                                        },
                                        n = {
                                            async onResendVerificationCodeEmail() {
                                                ht.siteMembersEmailConfirmationOnResendCodeClick(), await bt(`${Je}/v1/proceed`, {
                                                    method: "POST",
                                                    headers: {
                                                        "Content-Type": "application/json",
                                                        authorization: Ce()
                                            ...
                                            onCloseDialogCallback() {
                                                ht.closingDialog("VerificationCode"), (0, O.Fy)(Ve, d), Ct.hideDialog(), Nt.rejectAuthenticationRequest(), a(D.qd.CANCELED)
                                            },
                                            async onSubmitCallback(t) {
                                                ht.siteMembersEmailConfirmationSendCodeClick();
                                                if (N["specs.thunderbolt.verificationCodeDialogNewLogic"]) try {
                                                    const i = {
                                                            stateToken: e.stateToken || "",
                                                            code: t
                                                        },
                                                        a = await ft.request(Re(i), {
                                                            signedInstance: Ce()
                                                        });
                                                    return a ? .data
                                                } catch (e) {
                                    ...
                                    s.interactionEnded(D.sH.VERIFICATION_CODE), Ct.displayDialog("VerificationCodeDialog", o, n, void 0, t)
                                }))
                            },
                            async appWillMount() {
                                V && await Tt.getMemberDetails();
                                switch (new URL(n.requestUrl).searchParams.get("showDialog")) {
                                    ...
                                    case "RequestPasswordResetDialog":
                                        Tt.promptForgotPassword();
                                        break;
                                    case "ResetPasswordDialog":
                                        Tt.showResetPasswordDialog("faketoken");
                                        break;
                                    case "LoggedInResetPasswordDialog":
                                        Tt.showLoggedInResetPasswordDialog();
                                        break;
                                    case "WelcomeDialog":
                                        Tt.showWelcomeDialog();
                                        break;
                                    case "NoPermissionsToPageDialog":
                                        Tt.showNoPermissionsToPageDialog();
                                        break;
                                    case "NotificationDialog":
                                        Tt.showNotificationDialog("title", "description", "ok");
                                        break;
                                    case "ConfirmationEmailDialog":
                                        Tt.showConfirmationEmailDialog("fakemember");
                                        break;
                                    case "VerificationCodeDialog":
                                        Tt.showVerificationCodeDialog({
                                            email: "testEmail@test.com"
                                        });
                                        break;
                                    case "ExpiredResetPasswordDialog":
                                        Tt.showNotificationDialog(Ie.passwordHasExpiredTitle, Ie.passwordHasExpiredText, Ie.passwordHasExpiredOk, (() => Tt.promptForgotPassword(!1).then((() => {
                                            const e = b.getParsedUrl();
                                            g.navigate(e.href)
                                        }))))
                                }
                            ...
                            pageWillUnmount({
                                ...
                                [tt, it].includes(e) || Ct.hideDialog()
                            },
                            getSocialAuthComponentProps() {
                                return (0, O._G)({
                                    ...
                                    sessionManager: r,
                                    bsiManager: R,
                                    handleSocialLoginResponse: Tt.handleSocialLoginResponse,
                            ...
                            async getConnections() {
                                ...
                                return Dt.getEnabledConnections(e).then((e => e.map((({
                                    id: e,
                                    appDefId: t,
                                    displayName: i
                                }) => ({
                            ...
                            getLoginUrl() {
                                if (yt && N["specs.thunderbolt.shouldFetchLoginUrlByClientId"]) return Dt.getLoginRedirectUrl()
                            },
                            getLogoutUrl() {
                                if (yt) return Dt.getLogoutRedirectUrl()
                            },
                            getExternalBaseUrl() {
                                return N["specs.thunderbolt.shouldUseExternalBaseUrl"] ? Le : void 0
                            },
                            async register(e, t, i, a, o, n, r, c) {
                                n = n ? ? !1;
                                try {
                                    const l = await Dt.getCaptchaSettings();
                                    if (l.visible.signup && "Enabled" !== N["specs.ShouldPassCaptchaVerificationOnSignupSpec"] && !r && !c ? .otp && !c ? .verificationId) throw D.pH;
                                    s.interactionStarted(D.sH.CODE_SIGNUP), w.trackEvent((0, D.SU)(D.WW.ACTIONS.SIGNUP.SUBMIT));
                                    const u = C ? .getCurrentLightboxId(),
                                        g = _.getCurrentRouteInfo() ? .pageId,
                                        m = o || tt && u && tt === u || tt && g && tt === g,
                                        p = l.invisible.signup && m ? await _t(D.MA.SIGNUP) : void 0,
                                    ...
                                    const f = await Tt.getStateMachine(b, e),
                                        E = f ? .additionalData ? .protectedPages,
                                        P = (0, O.FB)(E),
                                        y = (0, O.$e)(f);
                                    if ((0, O._y)(d, Ve, {
                                            sessionToken: f ? .sessionToken
                                        }) && N["specs.thunderbolt.useNewPostLoginRedirect"]) return (0, O.yw)();
                                    const v = await Tt.applySessionToken(f ? .sessionToken, y, n && !P),
                                        A = P ? ? v;
                                    w.trackEvent((0, D.SU)(D.WW.ACTIONS.SIGNUP.SUCCESS)), w.trackEvent({
                                    ...
                                    throw (0, O.NU)(e) ? s.interactionEnded(D.sH.CODE_SIGNUP) : w.trackEvent((0, D.SU)(D.WW.ACTIONS.SIGNUP.FAIL)), e
                                }
                            },
                            async getStateMachine(e, t) {
                                const a = e ? .state;
                                if (a === Ee.Gd.REQUIRE_OWNER_APPROVAL) {
                                    if (ye) {
                                        const e = Ne[D.$m.ADMIN_APPROVAL];
                                        e && (Nt.rejectAuthenticationRequest(), C ? .open(e, (() => {
                                            throw (0, O._y)(d, Ve, {
                                                error: O.Mi.ACCESS_DENIED
                                            }), Nt.rejectAuthenticationRequest(), Tt.closeCustomAuthenticationDialogs(!1), new Error(D.qd.CANCELED)
                                        })).then((() => {
                                            Ct.hideDialog(!0)
                                        })))
                                    }
                                    return Tt.showAdminApprovalDialog(t)
                                }
                                if (a === Ee.Gd.REQUIRE_EMAIL_VERIFICATION) {
                                    if (ye) {
                                        const a = Ne[D.$m.EMAIL_CONFIRMATION];
                                        if (a) {
                                    ...
                                    const a = N["specs.thunderbolt.verificationCodeDialogNewLogic"],
                                        o = e ? .stateToken ? ? "";
                                    if (a) {
                                        const e = await Tt.showVerificationCodeDialog({
                                            email: t,
                                            stateToken: o
                                        });
                                        return Tt.getStateMachine(e, t)
                                    }
                                    return Tt.verifyEmail(t, e ? .stateToken).then((e => (Ct.hideDialog(), Tt.getStateMachine(e, t))))
                                }
                                return e
                            },
                            async verifyEmail(e, t, i, a, o) {
                                try {
                                    const s = {
                                        stateToken: t || "",
                                        code: o ? ? await Tt.showVerificationCodeDialog({
                                            email: e,
                                            stateToken: t,
                                            error: a
                                        }, !i)
                                    };
                                    return (await ft.request(Re(s), {
                                        signedInstance: Ce()
                                    })).data
                                } catch (i) {
                                    if (i === D.qd.CANCELED) throw i;
                                    const a = i ? .details ? .applicationError ? .code ? ? "BAD_CODE";
                                    return Tt.verifyEmail(e, t, !0, a)
                                }
                            },
                            async login(e, t, i, a = !1, o, s = !1) {
                                try {
                                    const n = await Dt.getCaptchaSettings();
                                    if (n.visible.login && !i ? .recaptchaToken && !o ? .otp && !o ? .verificationId) throw D.pH;
                                    w.trackEvent((0, D.SU)(D.WW.ACTIONS.LOGIN.SUBMIT));
                                    const r = C ? .getCurrentLightboxId(),
                                        c = _.getCurrentRouteInfo() ? .pageId,
                                        l = s || it && r && it === r || it && c && it === c,
                                        u = n.invisible.login && l ? await _t(D.MA.LOGIN) : void 0,
                                        g = [];
                                    ...
                                    const m = {
                                        ...
                                        h = await Tt.getStateMachine(p, e),
                                    ...
                                    const E = await Tt.applySessionToken(h ? .sessionToken, f, a && !b),
                                        P = b ? ? E,
                                        y = h ? .sessionToken;
                                    return {
                                        sessionToken: y,
                                    ...
                                    }), t ? .details ? .applicationError ? .code === D.OQ.WAITING_APPROVAL && Tt.showAdminApprovalDialog(e), t ? .response ? .data ? ? t
                                }
                            }
                        };
                    return a.export({
                        promptLogin: Tt.promptLogin,
                        logout: Tt.logout,
                        memberDetails: nt
                    }), i.update((e => ({ ...e,
                        shouldShowRenderingBlockingDialogs: e => e.relativeUrl !== D.m5 && !(!Tt.getForgotPasswordToken() && !Tt.shouldDisplayWelcomeDialog()),
                        showRenderingBlockingDialogs: () => {
                            const e = Tt.getForgotPasswordToken();
                            return e ? Tt.showResetPasswordDialog(e) : Tt.shouldDisplayWelcomeDialog() ? Tt.showWelcomeDialog() : void 0
                        }
                    }))), Tt
                }));
            var Me = i(16537),
            ...
            const Fe = (0, a.Og)([_.Np], (e => ({
                    getTpaHandlers() {
                        ...
                        return {
                            currentMember: t,
                            smCurrentMember: t,
                            logOutCurrentMember: (0, Be.V)(["site"], ((t, i) => {
                                e.logout(i ? .url)
                            })),
                            requestLogin: (0, Be.V)(["site"], i),
                            smRequestLogin: (0, Be.V)(["site"], i)
                        }
                    }
                }))),
                qe = (0, a.Og)([_.Np, (0, a.KT)(o.Gp, _.UU), r.Ji], ((e, {
                    componentIds: t
                }, i) => ({
                ...
                $e = e => {
                    e(_.Np, Me.$.AppWillMountHandler, Me.$.AppDidMountHandler).to(Ue), e(b.po.BlockingDialogs).to(We)
                },
                xe = e => {
                    e(Ve.dQ).to(Fe), e(Me.$.PageWillMountHandler).to(qe), e(Me.$.PageWillUnmountHandler).to((0, a.Og)([_.Np], (e => ({
                        pageWillUnmount(t) {
...
//# sourceMappingURL=https://static.parastorage.com/services/wix-thunderbolt/dist/group_9.8770902d.chunk.min.js.map