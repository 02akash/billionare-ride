...
(self.webpackJsonp__wix_thunderbolt_app = self.webpackJsonp__wix_thunderbolt_app || []).push([
    [2646, 3169, 5445, 569], {
        33615: function(e, t, a) {
            ...
            const i = (0, s.Og)([(0, s.KT)(o._K, n.U), (0, s.KT)(o.YG, n.U), (0, s.KT)(o.wk, n.U)], ((e, t, a) => {
                const s = a => {
                    const s = e.pagesSecurity[a];
                    return s && s.requireLogin ? r.SM : t.passwordProtected[a] || s && s.passwordDigest ? r.Pass : r.NONE
                };
                return {
                    async handle(t) {
                        ...
                        })(o, e.pagesSecurity[o]), i(t, u), null
                    }
                }
            }));
            var p = a(71085),
                ...
                P = a(32166),
                f = a(10553);
            const m = (0, s.Og)([(0, s.KT)(o.wk, n.U), (0, s.KT)(o.YG, n.U), (0, s.KT)(o._K, n.U), p.Ix, l.t7, (0, s.lq)(u.Np), (0, s.lq)(g.De), d.Tf, P.Ht, f.n], ((e, {
                publicPageIds: t,
                ...
                const P = async (e, t) => e === r.SM ? (async () => {
                        let e;
                        if (p)
                    ...
                    f = async (e, t, r = !1) => {
                        if (s && r) {
                            ...
                            return n.navigate(`${t}?appSectionParams=${r}`)
                        }
                        if (p && "SM" === t) {
                            const e = () => {
                ...
                async function m(t) {
                    ...
                    }))), await n.navigate(t.parsedUrl.href), r ? .()
                }
                const w = async (a, r) => {
                    const s = a.pageId;
                    try {
                        ...
                        if (e.update((e => ({ ...e,
                            ...
                            }))), u ? .reason === c.qd.CANCELED) return !!i.isLandingOnProtectedPage() && n.navigate("./");
                        if (p[s]) {
            ...
            var w = a(16537),
                h = a(60950);
            const M = (0, s.Og)([(0, s.KT)(o.wk, n.U), u.Np], ((e, t) => ({
                getTpaHandlers() {
                    return {
            ...
            const S = (0, s.Og)([(0, s.KT)(o.wk, n.U)], (function(e) {
                    return {
                ...
                k = e => {
                    e(p.po.Protected).to(i), e(w.$.AppWillMountHandler).to(m), e(y).to(S)
                },
                N = e => {
                    e(h.dQ).to(M)
                }
        ...
        11682: function(e, t, a) {
            ...
            const {
                ...
                usedPlatformApis: i
            } = window, p = Worker && s.includes("platform"), c = p ? (async () => {
                ...
                const {
                    ...
                    appsSpecData: c,
                    appDefIdToIsMigratedToGetPlatformApi: u,
                    forceEmptySdks: g,
                    loadNonMainSdksOnlyIfUsed: d
                } = s, l = t.startsWith("http://localhost:") || t.startsWith("https://bo.wix.com/suricate/") || document.baseURI !== location.href ? (e => {
                    const t = new Blob([`importScripts('${e}');`], {
                        type: "application/javascript"
                    });
                    return URL.createObjectURL(t)
                })(t) : t.replace(r.fileRepoUrl, `${n}/_partials`), P = new Worker(l), f = Object.keys(a.urls).filter((e => !c[e] ? .isModuleFederated)).reduce(((e, t) => (e[t] = a.urls[t], e)), {});
                if (p && p.mainSdks && p.nonMainSdks) {
                    Object.values(u).every((e => e)) && d || g ? P.postMessage({
                ...
                const m = "platform_create-worker ended";
                return performance.mark(m), performance.measure("Create Platform Web Worker", e, m), P
            })() : Promise.resolve()
        }
    }
]);
//# sourceMappingURL=https://static.parastorage.com/services/wix-thunderbolt/dist/platform.08affa9c.chunk.min.js.map