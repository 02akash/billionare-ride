    ...
    [4600], {
        ...
        59194: function(e, t, r) {
            ...
            function n(e) {
                ...
                let t = null;
                if ((0, i.$P)(e)) t = new Date(e.getTime());
                else {
                    t = e.constructor();
                    for (const r in e) t[r] = n(e[r])
                }
                return t
            }
        },
        91139: function(e, t, r) {
            "use strict";
            r.d(t, {
                $P: function() {
                    return o
        ...
        7488: function(e, t, r) {
            ...
            const n = e => isNaN(e) && !isNaN(new Date(e).getDate());
            ...
            function a(e) {
                ...
                const t = c(e);
                for (const e in t) t[e] && t[e].$date && n(t[e].$date) ? t[e] = new Date(t[e].$date) : "object" == typeof t[e] && null !== t[e] && (t[e] = a(t[e]));
                return t
            }
            ...
            function o(e) {
                if ("object" != typeof e || i(e)) return e;
                const t = c(e);
                for (const e in t) t[e] && i(t[e]) ? t[e] = l(t[e]) : "object" == typeof t[e] && null !== t[e] && (t[e] = o(t[e]));
                return t
            }
        ...
        51361: function(e) {
            ...
            e.exports = function(e) {
                ...
                if ("function" === i) return "GeneratorFunction" === r(e) ? "generatorfunction" : "function";
                if (function(e) {
        ...
        36695: function(e, t, r) {
            ...
            var i = r(59194),
                ...
                s = r(37511),
                a = r.n(s);
            const o = () => "WDE0001: Collection name must be a string.",
                u = () => "WDE0002: ItemId must be a string.",
                l = () => "WDE0068: Item ids must be an array of strings",
                c = e => `WDE0069: Failed to remove items from [${e}].\nCannot remove more than 1000 items in one request`,
                d = () => "WDE0003: FieldName must be a string.",
                h = (e, t) => `WDE0004: Failed to save [${e}] into [${t}].\nItems must be JavaScript objects.`,
                ...
                p = e => `WDE0006: Failed to bulk save items into [${e}].\nCannot insert more than 1000 items in one request`,
                g = () => "WDE0007: Invalid update. Updated object must have a string _id property.",
                f = (e, t, r, i) => `WDE0008: wixData.${e} expects between ${t} and ${r} arguments, but was called with ${i}.`,
                v = {
                ...
                y = e => `Failed to build a filter.\n${e.join("\n")}.`,
                N = e => `Failed to build group.\n${e.join("\n")}.`,
                _ = e => `Failed to build a sort.\n${e.join("\n")}.`,
                I = e => `WDE0018: Options must be an object with one or all of the following boolean properties: ${e.join(", ")}.`,
                b = () => "WDE0019: Reference operation takes a string ID or an object with an ID to be connected.",
                A = () => "WDE0021: Invalid reference",
                $ = {
                    queryInvalid: (e, t) => `Failed to perform query on [${e}].\n${t.join("\n")}`,
                    isNumber: (e, t, r) => `WDE0032: Invalid ${e} parameter [${(0,n.kK)(r)}]. ${e} parameter must be a ${t} number.`,
                ...
                S = {
                    typeIsString: (e, t) => `WDE0044: Invalid ${e} parameter value [${(0,n.kK)(t)}]. ${e} parameter must be a String.`,
                    typeIsStringNumberOrDate: (e, t) => `WDE0045: Invalid ${e} parameter value [${(0,n.kK)(t)}]. Valid ${e} parameter types are String, Number or Date.`,
                    sameType: (e, t, r) => `WDE0046: Invalid ${e} parameter values [${(0,n.kK)(t)}] and [${(0,n.kK)(r)}]. Both parameters must be of the same type.`,
                    typeIsStringNumberOrDateForAll: e => `WDE0047: Invalid ${e} usage. ${e} supports only Number, String or Date items.`,
                    validFieldName: (e, t) => `WDE0048: Invalid ${e} field value [${(0,n.kK)(t)}]. ${e} field must be a String.`,
                    isInstanceOfSameClass: (e, t, r) => `WDE0049: Invalid ${e} parameter [${(0,n.kK)(r)}]. ${e} expects ${t} only.`,
                    isForCollection: (e, t, r) => `WDE0050: Invalid ${e} parameter query for [${r}]. ${e} accepts ${t} for the same collection only.`
                },
                C = {
                    objectType: (e, t) => `WDE0056: ${e} should be an Object. Got ${k(t)} instead`,
                    arrayType: (e, t) => `WDE0057: ${e} should be an Array. Got ${k(t)} instead`,
                    arrayLength: (e, t, r) => `WDE0057: ${k(r)}.length is ${r.length}. ${e} Array should have length ${t}`,
                    comparisonOperatorType: (e, t) => `WDE0058: ${e} should be a Date, Number, or String. Got ${k(t)} instead`,
                    stringOperatorType: (e, t) => `WDE0059: ${e} should be a String. Got ${k(t)} instead`,
                    setOperatorItems: (e, t) => `WDE0060: ${e} Array should only contain values of types Date, Number, and String. Got ${k(t)} instead`,
                    inOperatorItems: e => `WDE0061: $in Array should have length 2, and match [String, Number]. Got ${k(e)} instead`,
                    matchesOperatorRequiredProperty: (e, t) => `WDE0062: $matches value ${k(t)} does not have property ${e}`,
                    matchesOperatorIgnoreCase: e => `WDE0063: $matches.ignoreCase should equal true. Got ${k(e)} instead`,
                    matchesOperatorSpecItems: e => `WDE0064: $matches.spec Array values should be either {"type":"anyOf","value":" -"} or {"type":"literal","value":String}. Got ${k(e)} instead`,
                    regexNotAllowed: () => "WDE0070: $regex keyword is not allowed."
                },
                D = {
                    typeIsStringOrArrayOfStrings: (e, t) => `WDE0051: Invalid ${e} parameters [${t.map(n.kK)}]. Valid ${e} values are String, Array of String or varargs String.`
                },
                T = {
                    sortModelType: e => `WDE0065: Sort Model should be an Array. Got ${k(e)} instead`,
                    sortModelItemType: e => `WDE0066: Sort Model Array should contain values of type Object only. Got ${k(e)} instead`,
                    sortModelItem: e => `WDE0067: Sort Model Array items should have a single property with value "asc" or "desc". Got ${k(e)} instead`
                },
                j = e => "WDE0055: Failed to parse server response." + (e ? ` ${e}` : ""),
                w = () => "WDE0080: Skip is not supported in cursor paging.",
                O = () => "WDE0109: Payload is too large.";
            ...
            function W(e) {
                return F(e, x.ValidationError)
            }

            function F(e, t, r) {
                const i = new(t && t !== x.UnknownError ? R : Error)(e);
                return i.code = t, r && (i.details = r), i
            }
            class R extends Error {
                constructor(e) {
                    super(e), this.name = "Error", this.errorGroup = "User", Error.captureStackTrace && Error.captureStackTrace(this, R)
                }
            }
            class V extends Error {
                constructor(e, t, r, i, n) {
                    super(e), this.message = e, this.code = t, this.item = r, this.name = i, this.originalIndex = n, Error.captureStackTrace && Error.captureStackTrace(this, V)
                }
            }
            class B {
                constructor() {
                ...
                arityIsZero(e) {
                    return this.addValidation((() => 0 === e.length), (() => E.arityIsZero(this.operatorName ? ? "")))
                }
                arityIsOne(e) {
                    return this.addValidation((() => 1 === e.length), (() => E.arityIsOne(this.operatorName ? ? "")))
                }
                arityIsTwo(e) {
                    return this.addValidation((() => 2 === e.length), (() => E.arityIsTwo(this.operatorName ? ? "")))
                }
                arityIsThree(e) {
                    return this.addValidation((() => 3 === e.length), (() => E.arityIsThree(this.operatorName ? ? "")))
                }
                arityIsAtLeastTwo(e) {
                    return this.addValidation((() => e.length >= 2), (() => E.arityIsAtLeastTwo(this.operatorName ? ? "")))
                }
                arityIsAtLeastOne(e) {
                    return this.addValidation((() => e.length >= 1), (() => E.arityIsAtLeastOne(this.operatorName ? ? "")))
                }
                addValidation(e, t) {
            ...
            class U extends M {
                arity(e, t, r, i) {
                    return this.addValidation((() => t.length <= i && t.length >= r), (() => f(e, r, i, t.length)))
                }
                _isObject(e, t) {
                    return this.addValidation((() => (0, n.Gv)(e)), (() => h(e, t)))
                }
                item(e, t, r) {
                    return this._isObject(e, t).addValidation((() => void 0 !== e._id ? (0, n.Kg)(e._id) : !r), (() => g()))
                }
                items(e, t) {
                    return this.addValidation((() => (0, n.cy)(e) && e.every((e => (0, n.Gv)(e) && (void 0 === e._id || null === e._id || (0, n.Kg)(e._id))))), (() => m(t))).addValidation((() => e.length <= 1e3), (() => p(t)))
                }
                fieldName(e) {
                    return this.addValidation((() => (0, n.Kg)(e)), (() => d()))
                }
                itemId(e) {
                    return this.addValidation((() => (0, n.Kg)(e)), (() => u()))
                }
                itemIds(e, t) {
                    return this.addValidation((() => (0, n.cy)(e) && e.every((e => (0, n.Kg)(e)))), (() => l())).addValidation((() => e.length <= 1e3), (() => c(t)))
                }
                _options(e, t) {
                    return this.addValidation((() => {
                        const r = (0, n.Gv)(e) && t.every((t => {
                            return "language" === t ? null == (r = e[t]) || (0, n.Kg)(r) && r.length > 0 : function(e) {
                                return null == e || (0, n.Lm)(e)
                            }(e[t]);
                            var r
                        }));
                        return null == e || r
                ...
                referenceRemoveParameters(e) {
                    return this.addValidation((() => (0, n.cy)(e) && e.every(G)), b)
                }
                referenceParameters(e) {
                    return this.addValidation((() => (0, n.cy)(e) && e.every(L)), b)
                }
                referenceParameter(e) {
                    return this.addValidation((() => L(e)), b)
                }
                isNonEmptyString(e, t) {
                    return this.addValidation((() => "string" == typeof e && e.length > 0), (() => $.isNonEmptyString(t)))
                }
                references(e) {
                    return this.addValidation((() => (0, n.cy)(e) && e.every((e => (0, n.Kg)(e.relationshipName) && L(e.left) && L(e.right)))), A)
                }
                options(e) {
                ...
                collectionName(e) {
                    return this.addValidation((() => (0, n.Kg)(e)), (() => o()))
                }
            }
            ...
            function L(e) {
                return (0, n.Kg)(e) && "" !== e || (0, n.Gv)(e) && e.hasOwnProperty("_id")
            }

            function G(e) {
                return (0, n.Kg)(e) || (0, n.Gv)(e) && e.hasOwnProperty("_id")
            }
            var K = r(69012),
                Q = r.n(K);
            ...
            class ee {
                constructor(e, t, r) {
                    this._validations = [], this.operatorName = e, this.ctor = r, this._invalidArguments = Y(t)
                }
                typeIsString(e) {
                    return this.addValidation((() => X(e)), (() => `Invalid ${this.operatorName} parameter value [${Z(e)}]. ${this.operatorName} parameter must be a String.`))
                }
                typeIsStringNumberOrDate(e) {
                    return this.addValidation((() => te(e)), (() => `Invalid ${this.operatorName} parameter value [${Z(e)}]. Valid ${this.operatorName} parameter types are String, Number or Date.`))
                }
                sameType(e, t) {
                    return this.addValidation((() => Z(e) === Z(t)), (() => `Invalid ${this.operatorName} parameter values [${Z(e)}] and [${Z(t)}]. Both parameters must be of the same type.`))
                }
                ...
                validFieldName(e) {
                    return this.addValidation((() => X(e)), (() => `Invalid ${this.operatorName} field value [${Z(e)}]. ${this.operatorName} field must be a String.`))
                }
                isInstanceOfSameClass(e) {
                    return this.addValidation((() => e instanceof this.ctor), (() => `Invalid ${this.operatorName} parameter [${Z(e)}]. ${this.operatorName} expects FilterBuilder only.`))
                }
                arityIsOne(e) {
            ...
            var oe = (e = class {}) => class extends e {
                constructor(e = {}) {
                ...
                or(e) {
                    ...
                    if (r) {
                        const r = ae(this.filterTree) ? [] : [this.filterTree];
                ...
                not(e) {
                    ...
                    if (r) {
                        const r = function(...e) {
                            return {
                                $and: e.reduce(((e, t) => H(t.$and) ? e.concat(t.$and) : e.concat([t])), [])
                            }
                        }(Y(this.filterTree), {
                            $not: [e.filterTree]
                        });
                ...
                _AndSetOperand(e, t, r) {
                    const [i, ...n] = Array.prototype.slice.call(r), s = H(n[0]) ? n[0] : n, [a] = this._filterValidator(t).arityIsAtLeastTwo(r).validFieldName(i).typeIsStringNumberOrDateForAll(s).validateAndAggregate(), o = this._makeNewFilter(i, e, s);
                    return this._copy(o, a)
                }
                _makeNewFilter(e, t, r) {
                    const i = Y(this.filterTree),
                        n = void 0 === r ? null : r,
                        s = this._buildFilter(e, t, n);
                    if (H(i.$and)) return i.$and.push(s), i;
                    return a = i, 0 === Object.keys(a).length ? se(s) : se(i, s);
                    var a
                }
                _buildFilter(e, t, r) {
                    if ("$eq" !== t) {
                ...
                _encode(e) {
                    return t = this.encoder, "function" === Q()(t) ? this.encoder(e) : e;
                    var t
                }
                _copy(e, t) {
            ...
            class le extends q {
                ...
                typeIsString(e) {
                    return this.addValidation((() => (0, n.Kg)(e)), (() => S.typeIsString(this.operatorName, e)))
                }
                typeIsStringNumberOrDate(e) {
                    return this.addValidation((() => ce(e)), (() => S.typeIsStringNumberOrDate(this.operatorName, e)))
                }
                sameType(e, t) {
                    return this.addValidation((() => (0, n.kK)(e) === (0, n.kK)(t)), (() => S.sameType(this.operatorName, e, t)))
                }
                typeIsStringNumberOrDateForAll(e) {
                    return this.addValidation((() => e.every(ce)), (() => S.typeIsStringNumberOrDateForAll(this.operatorName)))
                }
                validFieldName(e) {
                    return this.addValidation((() => (0, n.Kg)(e)), (() => S.validFieldName(this.operatorName, e)))
                }
                isInstanceOfSameClass(e) {
                    return this.addValidation((() => e instanceof this.ctor), (() => S.isInstanceOfSameClass(this.operatorName, this.constructorName, e)))
                }
                isForCollection(e, t) {
                    return this.addValidation((() => e.collectionName === t), (() => S.isForCollection(this.operatorName, this.constructorName, e.collectionName)))
                }
            }

            function ce(e) {
                return (0, n.Kg)(e) || (0, n.Et)(e) || (0, n.$P)(e)
            }
            var de = (e = class {}) => class extends(oe(e)) {
                constructor(e) {
                ...
                _validateCollectionName(e, t, r) {
                    ...
                    const i = function(e, t) {
                        ...
                        [n, s] = new le(r, e.invalidArguments, this.constructor, this.constructorName ? ? this.constructor.name).isForCollection(i, this.collectionName).validateAndAggregate();
                ...
                getFilterModel() {
                    if (this.invalidArguments.length > 0) throw W(y(this.invalidArguments));
                    return super.getFilterModel()
                }
                _filterValidator(e) {
                    return new le(e, this.invalidArguments, this.constructor, this.constructorName ? ? this.constructor.name)
                }
            };
            const he = (e = class {}) => class extends e {
                constructor(e = {}) {
                ...
                getSortModel() {
                    if (this.invalidArguments.length > 0) throw W(_(this.invalidArguments));
                    return this.orderBy
                }
                setSortModel(e) {
                ...
                _sortClause(e, t, r) {
                    let s = [];
                    this.orderBy && (s = (0, i.o)(this.orderBy));
                    const a = (o = s, u = e, e => {
                        const t = {
                            [e]: u
                        };
                    ...
                    var o, u;
                    const l = (0, n.cy)(r[0]) && 1 === r.length ? r[0] : Array.prototype.slice.call(r, 0),
                        [c, d] = this._sortValidator(t).arityIsAtLeastOne(r).allStrings(l).validateAndAggregate();
                    return d && l.forEach(a), this._copySort(s, c)
                }
                _sortValidator(e) {
            ...
            class me extends q {
                ...
                allStrings(e) {
                    return this.addValidation((() => e.every(n.Kg)), (() => D.typeIsStringOrArrayOfStrings(this.operatorName, e)))
                }
            }
            he();
            var pe = he;
            const ge = 9007199254740991;
            class fe extends q {
                constructor(e, t) {
                    super(t), this.operatorName = e
                }
                _isNumber(e, t) {
                    return this.addValidation((() => (0, n.Et)(t)), (() => $.isNumber(this.operatorName, e, t)))
                }
                isPositiveNumber(e) {
                ...
                isInteger(e) {
                    return this.addValidation((() => !Number.isNaN(e) && Number.isFinite(e) && Number.isInteger(e) && e < ge && e > -9007199254740991), (() => $.isInteger(this.operatorName, e)))
                }
                notGreaterThan(e, t) {
                    return this.addValidation((() => e <= t), (() => $.notGreaterThan(this.operatorName, e, t)))
                }
                nonEmptyString(e) {
                    return this.addValidation((() => "string" == typeof e && e.length > 0), (() => $.isNonEmptyString(this.operatorName)))
                }
            }
            ...
            class _e extends(de(pe())) {
                ...
                distinct(e, t) {
                    ...
                    return Ie(this.invalidArguments, this.collectionName).then((() => z().options(t).validateAndReject())).then((() => z().fieldName(s).validateAndReject())).then((() => this.provider.distinct(this.collectionName, this.getOptimizedFilter(), this.orderBy, s, n, this.limitNumber, t, this.cursor, void 0, i))).then((e => {
                        const i = e.pagingMetadata || new ye,
                            {
                                cursors: n,
                                hasNext: a = !1
                            } = i,
                            o = ve(n ? .next) || ve(n ? .prev) ? { ...t,
                                omitTotalCount: !0
                            } : t;
                        return new Ae({
                ...
                fields(...e) {
                    const t = (0, i.o)(this.projectedFields);
            ...
            function Ie(e, t) {
                const r = ((0, n.Kg)(t) ? [] : [o()]).concat(e);
                return r.length > 0 ? Promise.reject(W($.queryInvalid(t, r))) : Promise.resolve()
            }
            ...
            class Ae {
                constructor(e) {
                    this._executeQuery = e => this._pagingFunction.bind(e)(), this._withCalculatedSkip = (e, t) => (e.skipNumber = Ne(this.query, this.length, t), Promise.resolve(e)), e && (this._items = e.items, this._totalCount = e.totalCount, this._cursors = e.cursors, this._createdByCursor = e.createdByCursor, this._query = e.query, this._partialIncludes = e.partialIncludes, this._pagingFunction = e.pagingFunction, this._hasNext = e.hasNext, this.nextSkipNumber = Ne(this.query, this.length, !0), this.prevSkipNumber = Ne(this.query, this.length, !1))
                }
                get items() {
                    return this._items
                }
                ...
                next() {
                    return this.hasNext() ? ve(this.nextCursor) ? this._getNewCursorQuery(this.nextCursor, !0).then((e => this._executeQuery(e))).then((e => e._withTotalCount(this._totalCount))) : this._getNewQuery(!0).then((e => this._executeQuery(e))) : this._rejectNoNextPage()
                }
                prev() {
                    return this.hasPrev() ? ve(this.prevCursor) ? this._getNewCursorQuery(this.prevCursor, !1).then((e => this._executeQuery(e))).then((e => e._withTotalCount(this._totalCount))) : this._getNewQuery(!1).then((e => this._executeQuery(e))) : this._rejectNoPrevPage()
                }
                get nextCursor() {
                ...
                hasPrev() {
                    if (ve(this._createdByCursor) || this._cursors) return ve(this.prevCursor);
                    if (0 === (this.query.skipNumber || 0) || this.totalCount <= 0) return !1;
                    return Ne(this.query, this.length, !1) >= 0
                }
                toJSON() {
                    return {
                ...
                _getNewQuery(e) {
                    return this._withCalculatedSkip(new _e({
                ...
                _rejectNoPrevPage() {
                    return Promise.reject(W($.noPrevPage(this.query.collectionName)))
                }
                _rejectNoNextPage() {
                    return Promise.reject(W($.noNextPage(this.query.collectionName)))
                }
            }
            const $e = (e = class {}) => class extends e {
                ...
                count() {
                    const [e] = this._groupValidator(".count").arityIsZero(arguments).validateAndAggregate(), t = (0, i.o)(this.groupByTree) || {
                        _id: De()
                    };
                    return t.count = {
                        $sum: 1
                ...
                _addAccumulator(e, t, r, n) {
                    const s = (0, i.o)(this.groupByTree) || {
                            _id: De()
                        },
                        a = r || t + ((o = e).charAt(0).toUpperCase() + o.slice(1));
                    var o;
                    const u = {};
                    return u[`$${e}`] = `$${t}`, s[a] = u, this._copy(s, n)
                }
                _copy(e, t) {
                    return new this.constructor({ ...this,
                        groupByTree: e,
                ...
                _groupValidator(e) {
                    return new Se(e, this.invalidArguments)
                }
            };
            class Ee extends($e()) {
                _build() {
                    return function(e) {
                        if (e.length > 0) throw W(N(e))
            ...
            class Te extends(pe($e())) {
                ...
                run(e) {
                    ...
                    return (i = this.invalidArguments, n = this.collectionName, i.length > 0 ? Promise.reject(W(v.aggregateInvalid(n, i))) : Promise.resolve()).then((() => z().options(e).validateAndReject())).then((() => this.provider.runAggregate(this.collectionName, r, this.limitNumber, e, this.cursor))).then((({
                        items: e,
                        hasNext: r,
                        cursors: i
                    }) => new Oe({
                ...
                _aggregateValidator(e) {
                    return new xe(e, this.invalidArguments)
                }
            }
            ...
            function je(e) {
                ...
                return (0, n.Gv)(e._id) ? t.push(function(e) {
                    const t = Object.keys(e),
                        r = t.map((e => ({
                            [e]: `$_id.${e}`
                        })));
                    return Object.assign({}, ...r)
                }(e._id)) : (0, n.Kg)(e._id) && "0" !== e._id && t.push({
                    [e._id.substr(1)]: "$_id"
                }), Object.assign({}, ...t)
            }
            ...
            class Oe {
                ...
                hasPrev() {
                    return ve(this._createdByCursor) || this._cursors ? ve(this.prevCursor) : this._aggregate.skipNumber > 0
                }
                get length() {
                ...
                next() {
                    ...
                    let e;
                    if (ve(this.nextCursor)) e = this._getNewCursorAggregate(this.nextCursor);
                    else {
                        const t = Ne(this._aggregate, this.length, !0);
                ...
                prev() {
                    ...
                    let e;
                    return e = ve(this.prevCursor) ? this._getNewCursorAggregate(this.prevCursor) : this._aggregate.skip(Math.max(0, this._aggregate.skipNumber - this._aggregate.limitNumber)), e.run()
                }
                get nextCursor() {
                    return this._cursors && this._cursors.next
                }
                ...
                _getNewCursorAggregate(e) {
                    ...
                    return we(t.provider, t.collectionName, t.limitNumber, e)
                }
                _rejectNoPrevPage() {
                    return Promise.reject(W($.noPrevPage(this._aggregate.collectionName)))
                }
                _rejectNoNextPage() {
                    return Promise.reject(W($.noNextPage(this._aggregate.collectionName)))
                }
            }
            ...
            class xe extends q {
                ...
                filterBuilder(e) {
                    return this.addValidation((() => "FilterBuilder" === e.constructorName), (() => v.filterMustBeBuilder(this.operatorName)))
                }
                filterIsNotSet(e) {
                    return this.addValidation((() => void 0 === e.filterTree), (() => v.filterIsAlreadySet(this.operatorName)))
                }
                havingIsNotSet(e) {
                    return this.addValidation((() => void 0 === e.havingTree), (() => v.filterIsAlreadySet(this.operatorName)))
                }
                groupIsNotSet(e) {
                    return this.addValidation((() => function(e) {
                        return !e || "0" === e._id
                    }(e)), (() => v.groupIsAlreadySet(this.operatorName)))
                }
                _isNumber(e, t) {
                    return this.addValidation((() => (0, n.Et)(t)), (() => $.isNumber(this.operatorName, e, t)))
                }
                ...
                isInteger(e) {
                    return this.addValidation((() => !Number.isNaN(e) && Number.isFinite(e) && Number.isInteger(e) && e < ke && e > -9007199254740991), (() => $.isInteger(this.operatorName, e)))
                }
            }
            class Pe extends(de()) {
                get constructorName() {
            ...
            class Re {
                ...
                hasPrev() {
                    return ve(this._createdByCursor) || this._cursors ? ve(this.prevCursor) : this._skip > 0
                }
                next() {
                    return this.hasNext() ? ve(this.nextCursor) ? this._getNewCursorQuery(this.nextCursor)._fetch().then((e => e._withTotalCount(this._totalCount))) : this._withChangedSkip(!0)._fetch() : this._rejectNoNextPage()
                }
                prev() {
                    return this.hasPrev() ? ve(this.prevCursor) ? this._getNewCursorQuery(this.prevCursor)._fetch().then((e => e._withTotalCount(this._totalCount))) : this._withChangedSkip(!1)._fetch() : this._rejectNoPrevPage()
                }
                _rejectNoPrevPage() {
                    return Promise.reject(W($.noPrevPage(this._collectionName)))
                }
                _rejectNoNextPage() {
                    return Promise.reject(W($.noNextPage(this._collectionName)))
                }
                _withChangedSkip(e) {
                    const t = Ne({
                ...
                _getNewCursorQuery(e) {
                    return Ve({}, this._provider, this._collectionName, "", this._referenceAttribute, {
                        cursor: e,
                        limit: this._limit,
                        omitTotalCount: !0
                    })
                ...
                _fetch() {
                    return this._provider.queryReferenced(this._collectionName, this._holdingItemId, this._referenceAttribute, this._options).then((e => Ve(e, this._provider, this._collectionName, this._holdingItemId, this._referenceAttribute, this._options)))
                }
                _withTotalCount(e) {
                    return this._totalCount = e, this
                }
            ...
            function Be(e, t) {
                if (!e) return !1;
                if (Array.isArray(e)) return e.some((e => Be(e, t)));
                if ("object" == typeof e) {
                    return Object.keys(e).some((r => t(r) || Be(e[r], t)))
                }
                return !1
            }
            class qe {
                constructor(e) {
                    this.get = Me(((e, t, r, i) => z().arity("get", e, 2, 3).collectionName(t).itemId(r).options(i).validateAndReject().then((() => this.provider.get(t, r, i))).then(ze))), this.insert = Me(((e, t, r, i) => z().arity("insert", e, 2, 3).validateAndReject().then((() => Ue(this.provider, "insert")(t, r, i))))), this.query = e => be(this.provider, e), this.filter = () => We(), this.sort = () => new Fe, this.find = (e, t, r, i, n, s, a, o) => {
                        const u = be(this.provider, e);
                        u.filterTree = t, u.orderBy = r, u.skipNumber = i, u.limitNumber = n, u.included = a;
                        const l = { ...s,
                            omitTotalCount: o
                        };
                        return u.find(l)
                    }, this.remove = Me(((e, t, r, i) => z().arity("remove", e, 2, 3).collectionName(t).itemId(r).options(i).validateAndReject().then((() => this.provider.remove(t, r, i))).then(ze))), this.truncate = Me(((e, t, r) => z().arity("truncate", e, 1, 2).collectionName(t).options(r).validateAndReject().then((() => this.provider.truncate(t, r))).then(ze))), this.bulkRemove = Me(((e, t, r, i) => z().arity("bulkRemove", e, 2, 3).collectionName(t).itemIds(r, t).options(i).validateAndReject().then((() => this.provider.bulkRemove(t, r, i))).then(ze).then((e => {
                        const t = e.errors.map((e => new V(e.message, e.code, e.item, e.name, e.originalIndex)));
                        return { ...e,
                            errors: t
                        }
                    })))), this.save = Me(((e, t, r, i) => z().arity("save", e, 2, 3).validateAndReject().then((() => Ue(this.provider, "save")(t, r, i))))), this.update = Me(((e, t, r, i) => z().arity("update", e, 2, 3).validateAndReject().then((() => Ue(this.provider, "update")(t, r, i))))), this.fetch = Me(((e, t, r, i, n) => z().arity("fetch", e, 3, 4).isNonEmptyString(r, "cursor").validateAndReject().then((() => this.provider.find(t, void 0, void 0, void 0, i, n, void 0, !0, r))).then((e => function(e, t, r, i, n, s) {
                        const {
                            items: a,
                            totalCount: o,
                            partialIncludes: u,
                            ...
                            cursors: c,
                            hasNext: d = !1
                        } = l || new ye, h = be(t, r).limit(i), m = ve(c ? .next) || ve(c ? .prev) ? { ...n,
                            omitTotalCount: !0
                        } : n;
                        return new Ae({
                            createdByCursor: s,
                        ...
                        return e.limit = i, e.cursor = r, e.omitTotalCount = !0, this.provider.queryReferenced(t, void 0, void 0, e).then((r => Ve(r, this.provider, t, void 0, void 0, e)))
                    })))), this.fetchAggregate = Me(((e, t, r, i, n) => z().arity("fetchAggregate", e, 3, 4).isNonEmptyString(r, "cursor").validateAndReject().then((() => we(this.provider, t, i, r).run(n))))), this.queryReferenced = Me(((e, t, r, i, n) => z().arity("queryReferenced", e, 3, 4).referenceParameter(r).validateAndReject().then((() => {
                        const e = Ge(r),
                            s = n || {};
                        return this.provider.queryReferenced(t, e, i, s).then((r => Ve(r, this.provider, t, e, i, n)))
                    })))), this.insertReference = Me(((e, t, r, i, s, a) => {
                        let o, u, l;
                        return (0, n.cy)(r) ? (u = r, o = i, l = () => z().arity("insertReference", e, 2, 3).references(u).validateAndReject()) : (u = Le(s).map((e => ({
                            relationshipName: r,
                            left: i,
                            right: e
                        }))), o = a, l = () => z().arity("insertReference", e, 4, 5).references(u).validateAndReject()), l().then((() => this.provider.insertReferences(t, (e => e.map((e => ({
                            relationshipName: e.relationshipName,
                            left: Ge(e.left),
                            right: Ge(e.right)
                        }))))(u), o)))
                    })), this.replaceReferences = Me(((e, t, r, i, n, s) => (n = Le(n).map(Ge), i = Ge(i), z().arity("replaceReferences", e, 4, 5).referenceParameter(i).referenceParameters(n).validateAndReject().then((() => this.provider.replaceReferences(t, {
                        relationshipName: r,
                        left: i
                    }, n.map((e => ({
                        relationshipName: r,
                        right: e,
                        left: i
                    }))), s)))))), this.removeReference = Me(((e, t, r, i, n, s) => (n = Le(n).map(Ge), i = Ge(i), z().arity("removeReference", e, 4, 5).referenceParameter(i).referenceRemoveParameters(n).validateAndReject().then((() => 1 === n.length ? this.provider.removeReference(t, r, i, n[0], s) : this.provider.removeReferences(t, n.map((e => ({
                        relationshipName: r,
                        right: e,
                        left: i
                    ...
                    })))), this.getSchema = () => this.provider.getSchema(), this.group = (...e) => Ce(...e), this.aggregate = e => function(e, t) {
                        return new Te({
                            provider: e,
                            collectionName: t
                        })
            ...
            function Ue(e, t, r = !1) {
                return (i, n, s) => {
                    ...
                    }(n))).then((() => e[t](i, n, s))).then(ze).then((a = n, function(e) {
                        if (e) {
            ...
            function Ge(e) {
                return (0, n.Gv)(e) ? e._id : e
            }
            const {
                getSchemaNamespace: Ke
            } = r(48699);
            var Qe = r(7488);
                    ...
                    return et(e) ? function(e) {
                        ...
                        if (t ? .jsErrorValue) {
                            const {
                                ...
                                message: i,
                                code: n
                            } = t.jsErrorValue, s = new Error(i);
                            return s.name = r, s.code = n, s.details = e.details, s
                        }
                        return t ? .value
                    }(e) : function(e) {
                        ...
                        let a = i ? `${i}` : "";
                        return a += n ? `(${n})` : "", a += r ? ` ${r}` : "", a = a || t(e), P(j(a), x.UnknownError, s)
                    }(t)
                })).then((e => Promise.reject(e)));

            function et(e) {
                return e ? .details ? .applicationError ? .code === Je
            }
            const tt = e => {
                const t = He(e.details.applicationError.code);
                return P(e.details.applicationError.description, t, e.details)
            };
            const rt = e => t => it(e)({
            ...
            const ut = e => "object" == typeof e && null !== e && "get" in e && "function" == typeof e.get;
            var lt, ct, dt, ht;
            ! function(e) {
                e.LIVE = "LIVE", e.SANDBOX_PREFERRED = "SANDBOX_PREFERRED", e.SANDBOX = "SANDBOX"
            }(lt || (lt = {}));
            class mt {
                constructor({
                    ...
                    this.cloudDataUrl = e, this.gridAppId = t, this.environment = r, this.httpClientProvider = "function" == typeof i ? i : () => i, this.traceWith = s, this.authHeader = n
                }
                _unwrapDataItems(e) {
                ...
                insert(e, t, r) {
                    return this._traceWith("platformized-provider-insert", {
                        collectionName: e
                    })((() => z().collectionName(e).item(t, e, !1).options(r).validateAndReject().then((() => this._post("/v2/items", { ...pt(r),
                        dataCollectionId: e,
                        dataItem: {
                            id: t._id,
                            dataCollectionId: e,
                    ...
                    }, r))).then(this._unwrapDataItem)))
                }
                update(e, t, r) {
                    return this._traceWith("platformized-provider-update", {
                        collectionName: e
                    })((() => z().collectionName(e).item(t, e, !1).options(r).validateAndReject().then((() => this._post("/v2/items/update", { ...pt(r),
                        dataCollectionId: e,
                        dataItem: {
                            id: t._id,
                            dataCollectionId: e,
                ...
                save(e, t, r) {
                    return this._traceWith("platformized-provider-save", {
                        collectionName: e
                    })((() => z().collectionName(e).item(t, e, !1).options(r).validateAndReject().then((() => this._post("/v2/items/save", { ...pt(r),
                        dataCollectionId: e,
                        dataItem: {
                            id: t._id,
                            dataCollectionId: e,
                ...
                truncate(e, t) {
                    return this._traceWith("platformized-provider-truncate", {
                        collectionName: e
                    })((() => z().collectionName(e).validateAndReject().then((() => this._post("/v2/items/truncate", {
                        dataCollectionId: e
                    }, t))).then((() => Promise.resolve(null)))))
                }
                remove(e, t, r) {
                    return this._traceWith("platformized-provider-remove", {
                        collectionName: e
                    })((() => z().collectionName(e).itemId(t).options(r).validateAndReject().then((() => this._post("/v2/items/remove", { ...pt(r),
                        dataCollectionId: e,
                        dataItemId: t
                    }, r))).then(this._unwrapDataItem).catch((e => e && e.code === x.ItemDoesNotExist ? Promise.resolve(null) : Promise.reject(e)))))
                }
                bulkRemove(e, t, r) {
                    return this._traceWith("platformized-provider-bulk-remove", {
                        collectionName: e
                    })((() => z().collectionName(e).itemIds(t, e).bulkRemoveOptions(r).validateAndReject().then((() => 0 === t.length ? {
                        removedItemIds: [],
                        removed: 0,
                        skipped: 0,
                        errors: []
                    } : this._post("/v2/bulk/items/remove", { ...pt(r),
                        dataCollectionId: e,
                        dataItemIds: t
                    }, r).then((({
                        results: e
                ...
                get(e, t, r) {
                    return this._traceWith("platformized-provider-get", {
                        collectionName: e,
                        itemId: t
                    })((() => z().collectionName(e).itemId(t).options(r).validateAndReject().then((() => encodeURIComponent(t) === t ? this._get(`/v2/items/${t}`, { ...pt(r),
                        dataCollectionId: e,
                        dataItemId: t
                    }, r) : this._post("/v2/items/get", { ...pt(r),
                        dataCollectionId: e,
                        dataItemId: t
                    }, r))).then(this._unwrapDataItem).catch((e => e && e.code === x.ItemDoesNotExist ? Promise.resolve(null) : Promise.reject(e)))))
                }
                find(e, t, r, i, s, a, o, u, l, c) {
                    return this._traceWith("platformized-provider-find", {
                        collectionName: e
                    })((() => z().collectionName(e).options(a).validateAndReject().then((() => this._validateOrderBy(e, r))).then((() => this._validateFilter(e, t))).then((() => {
                        const d = this._getDataQuery(t, r, s, i, l, c),
                            h = (0, n.cy)(o) ? o.map((e => ({
                                fieldName: e
                            }))) : void 0;
                        return this._get("/v2/items/query", { ...pt(a),
                            dataCollectionId: e,
                            query: d,
                            referencedItemOptions: h,
                            returnTotalCount: !u
                        }, a).then((e => {
                            const {
                                dataItems: t,
                                pagingMetadata: r
                            } = e, i = this._unwrapDataItems(t), s = !!i.find((e => !(!(0, n.cy)(o) || !o.find((t => {
                                const r = e[t];
                                return (0, n.cy)(r) && r.length >= 50
                            })))));
                            return {
                                items: i,
                                partialIncludes: s,
                ...
                runAggregate(e, t, r, i, n) {
                    return this._traceWith("platformized-provider-aggregate", {
                        collectionName: e
                    })((() => z().collectionName(e).options(i).validateAndReject().then((() => {
                        const s = (0, nt.A)(t);
                        return this._get("/v2/items/aggregate", { ...pt(i),
                            dataCollectionId: e,
                            initialFilter: s.preFilteringStep,
                            aggregation: ot(s.processingStep),
                            finalFilter: s.postFilteringStep,
                ...
                _getPaging(e, t, r) {
                    if (r && t > 0) throw P(w(), x.ValidationError);
                    return r ? {
                        cursorPaging: {
                            limit: e,
                            cursor: r
                ...
                count(e, t, r) {
                    return this._traceWith("platformized-provider-count", {
                        collectionName: e
                    })((() => z().collectionName(e).options(r).validateAndReject().then((() => this._validateFilter(e, t))).then((() => this._get("/v2/items/count", { ...pt(r),
                        dataCollectionId: e,
                        filter: t
                    }, r)))))
                }
                _sortingFromOrder(e, t) {
                    const r = ((0, n.cy)(e) ? e : []).find((e => e.hasOwnProperty(t))),
                        i = r && r.hasOwnProperty(t) ? r[t] : void 0;
                    return i ? i.toUpperCase() : i
                }
                distinct(e, t, r, i, n, s, a, o, u, l) {
                    return this._traceWith("platformized-provider-distinct", {
                        collectionName: e
                    })((() => z().collectionName(e).options(a).validateAndReject().then((() => this._validateOrderBy(e, r))).then((() => this._validateFilter(e, t))).then((() => {
                        const c = this._getDataQuery(t, r, s, n, o, u);
                        return this._get("/v2/items/query-distinct-values", { ...pt(a),
                            dataCollectionId: e,
                            fieldName: i,
                            filter: c.filter,
                            order: this._sortingFromOrder(r, i),
                            paging: c.paging,
                            cursorPaging: c.cursorPaging,
                            ...l ? {} : {
                                returnTotalCount: !0
                            }
                        }, a).then((({
                ...
                bulkInsert(e, t, r) {
                    return this._traceWith("platformized-provider-bulk-insert", {
                        ...
                        return z().collectionName(e).items(t, e).bulkInsertOptions(r).validateAndReject().then((() => {
                            ...
                            const n = i ? "/v2/bulk/items/save" : "/v2/bulk/items/insert";
                            return this._post(n, { ...pt(r),
                                dataCollectionId: e,
                                dataItems: t.map((t => ({
                                    id: t._id,
                                    dataCollectionId: e,
                ...
                bulkSave(e, t, r) {
                    return this._traceWith("platformized-provider-bulk-save", {
                        collectionName: e
                    })((() => z().collectionName(e).items(t, e).bulkInsertOptions(r).validateAndReject().then((() => 0 === t.length ? {
                        insertedItemIds: [],
                        updatedItemIds: [],
                        inserted: 0,
                        updated: 0,
                        skipped: 0,
                        errors: []
                    } : this._post("/v2/bulk/items/save", { ...pt(r),
                        dataCollectionId: e,
                        dataItems: t.map((t => ({
                            id: t._id,
                            dataCollectionId: e,
                ...
                bulkUpdate(e, t, r) {
                    return this._traceWith("platformized-provider-bulk-update", {
                        collectionName: e
                    })((() => z().collectionName(e).items(t, e).bulkUpdateOptions(r).validateAndReject().then((() => 0 === t.length ? {
                        updatedItemIds: [],
                        inserted: 0,
                        skipped: 0,
                        updated: 0,
                        errors: []
                    } : this._post("/v2/bulk/items/update", { ...pt(r),
                        dataCollectionId: e,
                        dataItems: t.map((t => ({
                            id: t._id,
                            dataCollectionId: e,
                ...
                queryReferenced(e, t, r, i) {
                    return this._traceWith("platformized-provider-query-referenced", {
                        ...
                        const n = ((i = i || {}).order || "ASC").toUpperCase(),
                            ...
                            a = i.limit || 50,
                            o = i.cursor;
                        return z().collectionName(e).options(i).validateAndReject().then((() => this._get("/v2/items/query-referenced", { ...pt(i),
                            dataCollectionId: e,
                            referringItemId: t,
                ...
                insertReferences(e, t, r) {
                    return this._traceWith("platformized-provider-insert-references", {
                        collectionName: e
                    })((() => z().collectionName(e).options(r).validateAndReject().then((() => {
                        const i = t.map((({
                            relationshipName: e,
                            left: t,
                            right: r
                        ...
                        return this._post("/v2/bulk/items/insert-references", { ...pt(r),
                            dataCollectionId: e,
                ...
                replaceReferences(e, t, r, i) {
                    return this._traceWith("platformized-provider-replace-references", {
                        collectionName: e
                    })((() => z().collectionName(e).options(i).validateAndReject().then((() => this._post("/v2/items/replace-references", { ...pt(i),
                        dataCollectionId: e,
                ...
                removeReferences(e, t, r) {
                    return this._traceWith("platformized-provider-remove-references", {
                        collectionName: e
                    })((() => z().collectionName(e).options(r).validateAndReject().then((() => this._post("/v2/bulk/items/remove-references", { ...pt(r),
                        dataCollectionId: e,
                ...
                isReferenced(e, t, r, i, n) {
                    return this._traceWith("platformized-provider-is-referenced", {
                        collectionName: e
                    })((() => z().collectionName(e).options(n).validateAndReject().then((() => this._post("/v2/items/is-referenced", { ...pt(n),
                        dataCollectionId: e,
                ...
                _validateOrderBy(e, t) {
                    const r = e => T.sortModelType(e);
                    if ([null, void 0].includes(t)) return Promise.resolve();
                    if (i = t, !(0, n.cy)(i)) return Promise.reject(this._validationError(e, [r(t)]));
                    var i;
                    const s = t.flatMap((e => (e => !(0, n.Gv)(e))(e) ? (e => T.sortModelItemType(e))(e) : (e => {
                        const t = Object.values(e);
                        return !(1 === t.length && ("asc" === t[0] || "desc" === t[0]))
                    })(e) ? (e => T.sortModelItem(e))(e) : []));
                    return s.length ? Promise.reject(this._validationError(e, s)) : Promise.resolve()
                }
                _validateFilter(e, t) {
                    const r = C.objectType,
                        i = C.arrayType,
                        s = C.arrayLength,
                        a = C.comparisonOperatorType,
                        o = C.stringOperatorType,
                        u = C.setOperatorItems,
                        l = C.inOperatorItems,
                        c = C.matchesOperatorRequiredProperty,
                        d = C.matchesOperatorIgnoreCase,
                        h = C.matchesOperatorSpecItems,
                        m = C.regexNotAllowed,
                        p = (e, t) => void 0 === t || (0, n.Gv)(t) ? [] : [r(e, t)],
                        g = (e, t) => (0, n.cy)(t) ? t.flatMap((t => p(e, t))) : [],
                        f = (e, t) => void 0 === t || (0, n.cy)(t) ? [] : [i(e, t)],
                        v = (e, t) => void 0 === t || (0, n.Kg)(t) || (0, n.Et)(t) || (0, n.$P)(t) ? [] : [a(e, t)],
                        y = (e, t) => void 0 === t || (0, n.Kg)(t) ? [] : [o(e, t)],
                        N = (e, t) => (0, n.cy)(t) ? t.every((e => (0, n.$P)(e) || (0, n.Kg)(e) || (0, n.Et)(e))) ? [] : [u(e, t)] : [],
                        _ = (e, t, r) => (0, n.cy)(t) ? t.length === r ? [] : [s(e, r, t)] : [],
                        I = e => {
                            if (!(0, n.Gv)(e)) return [];
                            if (void 0 === e.ignoreCase) return [c("ignoreCase", e)];
                            if (!0 !== e.ignoreCase) return [d(e.ignoreCase)];
                            if (void 0 === e.spec) return [c("spec", e)];
                            if (!(0, n.cy)(e.spec)) return [i("$matches.spec", e.spec)];
                            const t = e.spec.find((e => !(e => !!(0, n.Gv)(e) && ("anyOf" === e.type && " \t\n-" === e.value || !("literal" !== e.type || !(0, n.Kg)(e.value))))(e)));
                            return void 0 !== t ? [h(t)] : []
                        },
                        b = e => {
                            if (!(0, n.Gv)(e)) return [];
                            ...
                            let T = [].concat(f("$and", t)).concat(g("Filter Model", t)).concat(f("$or", r)).concat(g("Filter Model", r)).concat(f("$not", i)).concat(g("Filter Model", i)).concat(f("$hasSome", A)).concat(f("$hasAll", $)).concat(f("$in", E)).concat(N("$hasSome", A)).concat(N("$hasAll", $)).concat(v("$gt", s)).concat(v("$gte", a)).concat(v("$lt", o)).concat(v("$lte", u)).concat(y("$startsWith", c)).concat(y("$endsWith", d)).concat(y("$contains", h)).concat(_("$not", i, 1)).concat(_("$in", E, 2)).concat((j = E, (0, n.cy)(j) ? 2 !== j.length || (0, n.Kg)(j[0]) && (0, n.Et)(j[1]) ? [] : [l(j)] : [])).concat(p("$matches", S)).concat(I(S)).concat((e => void 0 === e ? [] : [m()])(C));
                            var j;
                            return T.length ? T : (T = [].concat(t ? t.flatMap(b) : []).concat(r ? r.flatMap(b) : []).concat(i ? i.flatMap(b) : []), T.length ? T : Object.values(D).flatMap(b))
                        };
                    if ([null, void 0].includes(t)) return Promise.resolve();
                    if (!(0, n.Gv)(t)) return Promise.reject(this._validationError(e, [r("Filter Model", t)]));
                    const A = b(t);
                    return A.length ? Promise.reject(this._validationError(e, A)) : Promise.resolve()
                }
                _validationError(e, t) {
                    return W($.queryInvalid(e, t))
                }
                _getAuthHeader() {
                    return Promise.resolve(ut(this.authHeader) ? this.authHeader.get() : this.authHeader)
                }
                _get(e, t, r) {
                    return this._call(e, t, !0, r)
                }
                _post(e, t, r) {
                    return this._call(e, t, !1, r)
                }
                _call(e, t, r, i) {
                    return Promise.all([this._getGridAppId(), this._getAuthHeader()]).then((([n, s]) => {
                        const a = `${this.cloudDataUrl}${e}`,
                            o = e => this.traceWith("wix-data-api-call", {
                                url: a
                            })((() => {
                                const e = { ...(0, Qe.oq)(t),
                                ...
                                if (r) {
                                    const t = `${a}?.r=${(0,st.A)(e)}`;
                                    if (t.length <= 2048) return this.httpClientProvider(i).get(t, {
                                        headers: o,
                                        includeWixHeaders: !0
                                    })
                                }
                                return this.httpClientProvider(i).post(a, e, {
                                    headers: o,
                                    includeWixHeaders: !0
                                })
                            })).catch((t => this.traceWith("wix-data handling 503", {
                                retriesLeft: e,
                                httpStatus: t ? .response ? .status,
                                error: t,
                                isGetRequest: r
                            })((() => r && e > 0 && 503 === t ? .response ? .status ? o(e - 1) : Promise.reject(t)))));
                        return o(2).catch(Ye(this.traceWith)).then((u = this.traceWith, e => u("platformized-data-response", {
                ...
                _getGridAppId() {
                    return Promise.resolve(ut(this.gridAppId) ? this.gridAppId.get() : this.gridAppId)
                }
                _traceWith(e, t) {
            ...
            function pt(e) {
                ...
                e.LIVE = "LIVE", e.SANDBOX = "SANDBOX", e.TRASH_LIVE = "TRASH_LIVE"
            }(ct || (ct = {})),
            function(e) {
            ...
            function ft({
                ...
                const o = i || (r === ct.LIVE ? lt.LIVE : lt.SANDBOX);
                return new qe(new mt({
                    cloudDataUrl: e,
                    gridAppId: t,
                    environment: o,
                    httpClient: n,
            ...
            function yt({
                ...
                const a = {
                        get() {
                            ...
                            return s.isBlocksApp(n) && s.canAppInstanceBeUsedForAuthorization(e) ? e : t.getWixCodeInstance()
                        }
                    },
                    o = Boolean(i.experiments["specs.thunderbolt.UseCloudDataUrlWithBaseExternalUrl"]),
                    {
                        gridAppId: u,
                        environment: l,
                        cloudDataUrl: c,
                        cloudDataUrlWithExternalBase: d
                    } = e,
                    {
                        httpClient: h
                    } = r;
...
//# sourceMappingURL=feature-data-wix-code-sdk.7d1ceea2.chunk.min.js.map