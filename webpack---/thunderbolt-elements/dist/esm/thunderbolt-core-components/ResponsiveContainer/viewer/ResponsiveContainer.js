...
import {
    getAriaAttributes
} from '@wix/editor-elements-common-utils/src/commons/a11y';
...
const ResponsiveContainer = ({
    ...
    const wrapWithOverflowWrapperIfNeeded = useCallback((reactChildren) => hasOverflowWrapper ? (React.createElement(OverflowWrapper, {
        className: classNames(overlowWrapperClassName, extraRootClass)
    }, reactChildren)) : (reactChildren), [hasOverflowWrapper, overlowWrapperClassName, extraRootClass]);
