...
const Video = props => {
    ...
    const VideoPosterImage = (React.createElement(React.Fragment, null,
        posterImageInfo.filterEffectSvgString && (React.createElement("svg", {
        ...
        React.createElement(Image, {
            ...
            className: classNames(styles.videoPoster, styles.videoPosterImg, VIDEO_POSTER_CLASS_FOR_LAYOUT, extraClassName),
            imageStyles: {
                width: '100%',
                height: '100%'
            },
    ...
    return (
        ...
        React.createElement("wix-video", {
                id: id,
                "data-video-info": videoInfoString,
                "data-motion-part": "BG_IMG",
                class: classNames(styles.videoContainer, VIDEO_CLASS_FOR_LAYOUT, extraClassName)
            },
