...
/**
 * Compare two gradients as nested objects
 * @param a
 * @param b
 * @returns Whether the gradients are equal
 */
function compare(a, b) {
    return compareNestedObjects(a, b);
}

/**
 * Generate a hash of the gradients object, will sort the nested objects before hashing
 * @param gradients
 * @returns hash of the gradients object
 */
function hash(gradients) {
    return getSimpleHash(JSON.stringify(getSortedNestedObjects(gradients)));
}
