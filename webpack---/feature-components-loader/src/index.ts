...
export const site: ContainerModuleLoader = (bind) => {
	...
	bind(ComponentWrapperSymbol).to(ComponentDidMountWrapper)
}

export const editor = bindCommonSymbols

// Public Symbols
export { ComponentsLoaderSymbol, ComponentsRegistrarSymbol, ComponentWrapperSymbol, ExecuteComponentWrappersSymbol }
