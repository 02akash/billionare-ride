...
export const createValuePropsSdkFactory = (valueSanitizer, valueSchema, inputValidator) => composeSDKFactories([
    changePropsSDKFactory,
    withValidation(_createValuePropsSDKFactory(valueSanitizer, valueSchema, inputValidator), {
        type: ['object'],
        properties: {},
    }),
]);
