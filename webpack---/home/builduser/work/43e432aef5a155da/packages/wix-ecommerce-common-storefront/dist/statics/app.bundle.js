...
(function(modules) { // webpackBootstrap
    ...
    /******/
    __webpack_require__.p = "https://static.parastorage.com/services/wix-ecommerce-common-storefront/67679af1669d56d964c9f76e7b9e5ce92421e3cb1c29097ead75592a/";
    /******/
    /******/
...
([
    ...
    (function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony export (binding) */
        __webpack_require__.d(__webpack_exports__, "__addDisposableResource", function() {
            return __addDisposableResource;
        });
        /* harmony export (binding) */
        __webpack_require__.d(__webpack_exports__, "__disposeResources", function() {
    ...
    (function(module, exports, __webpack_require__) {
        ...
        "use strict";
        angular.module("debounce", []).service("debounce", ["$timeout", function(e) {
            return function(n, u, r) {
                function i() {
                    ...
                    var i = function() {
                        ...
                        l = r && !t;
                    return t && e.cancel(t), t = e(i, u), l && (o = n.apply(a, c)), o
                }
                var t, c, a, o;
        ...
        }]).directive("debounce", ["debounce", "$parse", function(e, n) {
            return {
                require: "ngModel",
                priority: 999,
                link: function(u, r, i, t) {
                    var c, a, o = n(i.debounce)(u),
                        l = !!n(i.immediate)(u),
                        d = t.$render.bind(t),
                        s = e(function(e) {
    ...
    (function(module, exports, __webpack_require__) {
        ...
        var CartStorage = /** @class */ (function() {
            ...
            CartStorage.prototype.removeCart = function(cartId) {
                this.sdkEvents.broadcast('Cart.Cleared', {
                    cartId: cartId
                });
            };
            return CartStorage;
    ...
    (function(module, exports, __webpack_require__) {
        ...
        (function(global) {
            ...
            /* WEBPACK VAR INJECTION */
        }.call(this, __webpack_require__( /*! ./../../../../webpack/buildin/global.js */ 40)))
            ...
            return {
                ...
                link: function(scope, el) {
                    ...
                    if (sectionId === 'product_page') {
                        sdkAdapter
                            .buildCustomizedUrl('wix.stores.sub_pages.product', {
                                slug: params
                            }, {
                    ...
                    sdkAdapter.getSectionUrl({
                        ...
                        scope.$evalAsync(function() {
                            ...
                            sectionUrl = [sectionUrl, queryParams].filter(function(f) {
                                return !!f;
                            }).join('?');
    ...
    (function(module, exports, __webpack_require__) {
        ...
        function newCartToOldCartStructure(newCart) {
            ...
            oldCart.items = (oldCart.items || []).map(function(item) {
                return (tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({}, item), item.product), {
        ...
        var CartServices = /** @class */ (function() {
            ...
            CartServices.prototype.notifyCartChange = function(cart, extraParams) {
                var cartOldStructure = tslib_1.__assign(tslib_1.__assign({}, newCartToOldCartStructure(cart)), {
            ...
            CartServices.prototype.subscribeToCartChanges = function(listener) {
                this.sdkAdapter.subscribe(cart_1.CartEvents.CHANGED, function(e) {
                    return listener(e.data);
                }, false);
            };
            CartServices.prototype.subscribeToCartCleared = function(listener) {
                this.sdkAdapter.subscribe(cart_1.CartEvents.CLEARED, function(e) {
                    return listener(e.data);
                }, false);
            };
            return CartServices;
                                            ...
                                            "selections": [{
                                                ...
                                                "selectionSet": {
                                                    ...
                                                    "selections": [{
                                                        ...
                                                        "name": {
                                                            "kind": "Name",
                                                            "value": "convertedFormattedComparePrice"
                                                        },
                                                        "arguments": [],
                                                        "directives": [],
                                                        "selectionSet": null
                                                        ...
                                                        "name": {
                                                            "kind": "Name",
                                                            "value": "convertedFormattedTotalPrice"
                                                        },
                                                        "arguments": [],
                                                        "directives": [],
                                                        "selectionSet": null
                                                        ...
                                                        "selectionSet": {
                                                            ...
                                                            "selections": [{
                                                                ...
                                                                "name": {
                                                                    "kind": "Name",
                                                                    "value": "formattedPriceBeforeDiscount"
                                                                },
                                                                "arguments": [],
                                                                "directives": [],
                                                                "selectionSet": null
                                                ...
                                                "selectionSet": {
                                                    ...
                                                    "selections": [{
                                                        ...
                                                        "name": {
                                                            "kind": "Name",
                                                            "value": "formattedShippingWithoutTax"
                                                        },
                                                        "arguments": [],
                                                        "directives": [],
                                                        "selectionSet": null
