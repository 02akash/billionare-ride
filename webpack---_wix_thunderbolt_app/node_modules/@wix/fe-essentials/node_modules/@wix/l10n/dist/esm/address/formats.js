 ...
 * Google's open-source address library https://chromium-i18n.appspot.com/ssl-address.
 * Some of the formats were overriden using the formatsOverrides.js file.
 */
...
export const defaultFormat = '%N%n%O%n%A%n%C';
