...
export default class WixDataApi {
    constructor(provider) {
        ...
        this.fetch = withArgs((args, collectionName, cursor, limit, options) => apiValidator()
            ...
            .validateAndReject()
            .then(() => {
                const omitTotalCount = true; // Total count must be omitted for cursored requests
                return this.provider.find(collectionName, undefined, undefined, undefined, limit, options, undefined, omitTotalCount, cursor);
            })
            .then((result) => queryResultFactory(result, this.provider, collectionName, limit, options)));
