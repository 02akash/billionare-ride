...
export function setActivityCounters(payload) {
    var _a = serializer(_setActivityCountersRequest, {}),
        toReq = _a.toJSON,
        fromReq = _a.fromJSON;
...
export function incrementActivityCounters(payload) {
    var _a = serializer(_incrementActivityCountersRequest, {}),
        toReq = _a.toJSON,
        fromReq = _a.fromJSON;
...
export function getActivityCounters(payload) {
    var _a = serializer(_getActivityCountersRequest, {}),
        toReq = _a.toJSON,
        fromReq = _a.fromJSON;
...
export function queryActivityCounters(payload) {
    var _a = serializer(_queryActivityCountersRequest, {}),
        toReq = _a.toJSON,
        fromReq = _a.fromJSON;
