...
function reverseMigrateOptions(flatOptionsObject) {
    ...
    ///----------- LAYOUT -------------///
    oldOptions = changeNames(oldOptions, __spreadArray([], nameChangedLayoutParams, true).map(function(ele) {
        return __spreadArray([], ele, true).reverse();
    }));
    oldOptions = reverseBooleans(oldOptions, __spreadArray([], reversedLayoutParams, true).map(function(ele) {
        return __spreadArray([], ele, true).reverse();
    }));
    ...
    ///----------- BEHAVIOUR -------------///
    oldOptions = changeNames(oldOptions, __spreadArray([], nameChangedBehaviourParams, true).map(function(ele) {
        return __spreadArray([], ele, true).reverse();
    }));
    oldOptions = reverseBooleans(oldOptions, __spreadArray([], reversedBehaviourParams, true).map(function(ele) {
        return __spreadArray([], ele, true).reverse();
    }));
    ...
    ///----------- STYLING -------------///
    oldOptions = changeNames(oldOptions, __spreadArray([], nameChangedStylingParams, true).map(function(ele) {
        return __spreadArray([], ele, true).reverse();
    }));
    return oldOptions;
}
