...
const isValidAppData = (app) => Boolean(app ? .components);
...
export default function parseBlocksConfig(appParams) {
    ...
    return {
        ...
        code: {
            ...
            experimentsQueryString: appParams.appData ? .blocksConsumerData ? .codeExperimentsQueryString || '', // Should be replaced with a type guard once WBL-2343 is done
        },
        siteId,
        metaSiteId,
        revision,
