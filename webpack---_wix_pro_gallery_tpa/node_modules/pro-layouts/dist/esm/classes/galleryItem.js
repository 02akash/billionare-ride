...
var GalleryItem = /** @class */ (function() {
    ...
    GalleryItem.prototype.processedMediaUrl = function(resizeMethod, requiredWidth, requiredHeight, sharpParams, createMultipleUrls) {
        ...
        var imgUrl = this.url;
        if (this.isText) {
            return Object.assign.apply(Object, __spreadArray([{}], Object.values(GALLERY_CONSTS.urlTypes).map(function(value) {
                var _a;
                return (_a = {},
                    _a[value] = function() {
                        return '';
                ...
                case 'wix':
                    if (linkData) {
                        switch (linkData.type) {
                            case 'PageLink':
                                return "Go to Page ".concat(linkData.pageName);
                            case 'AnchorLink':
                                return "Scroll to ".concat(linkData.anchorName);
                            case 'ExternalLink':
                                return "".concat(linkData.url);
                            case 'EmailLink':
                                return "Email ".concat(linkData.recipient);
                            case 'PhoneLink':
                                return "Call ".concat(linkData.phoneNumber);
                            case 'DocumentLink':
                                return "Open ".concat(linkData.name);
                            default:
                                return 'Go to Link';
                        }
                    } else {
                        ...
                        switch (linkData.type) {
                            case 'PageLink':
                                if (linkData.pageName) {
                                    return "PAGE - ".concat(linkData.pageName);
                                } else {
                                    return 'PAGE';
                                }
                            case 'AnchorLink':
                                return "ANCHOR - ".concat(linkData.anchorName);
                            case 'ExternalLink':
                                return "LINK - ".concat(linkData.url);
                            case 'EmailLink':
                                return "EMAIL - ".concat(linkData.recipient);
                            case 'PhoneLink':
                                return "PHONE - ".concat(linkData.phoneNumber);
                            case 'DocumentLink':
