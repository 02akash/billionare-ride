/*! Raven.js 3.22.2 (2e9f9b6) | github.com/getsentry/raven-js */ ! function(a) {
    ...
    return function a(b, c, d) {
        ...
        1: [function(a, b, c) {
            function d(a, b) {
                ...
                b = b || window.angular, b && (b.module(g, []).provider("Raven", c).config(["$provide", f]), a.setDataCallback(e(function(a) {
                    return d.a(a)
                })))
            }
            var e = a(6).wrappedCallback,
            ...
            d.a = function(a) {
                ...
                return a
            }, d.moduleName = g, b.exports = d, a(5).addPlugin(b.exports)
        }, {
            5: 5,
            6: 6
        }],
        ...
        4: [function(a, b, c) {
            (function(c) {
                ...
                function f() {
                    this.b = !("object" != typeof JSON || !JSON.stringify), this.c = !n(K), this.d = !n(L), this.e = null, this.f = null, this.g = null, this.h = null, this.i = null, this.j = null, this.k = {}, this.l = {
                    ...
                    }, this.n = 0, this.o = !1, this.p = Error.stackTraceLimit, this.q = J.console || {}, this.r = {}, this.s = [], this.t = d(), this.u = [], this.v = [], this.w = null, this.x = J.location, this.y = this.x && this.x.href, this.z();
                    for (var a in this.q) this.r[a] = this.q[a]
                }
                var g = a(7),
                    h = a(8),
                    i = a(2),
                ...
                f.prototype = {
                    ...
                    config: function(a, b) {
                        var c = this;
                        if (c.h) return this.A("error", "Error: Raven has already been configured"), c;
                        if (!a) return c;
                        var d = c.l;
                        b && s(b, function(a, b) {
                            "tags" === a || "extra" === a || "user" === a ? c.k[a] = b : d[a] = b
                    ...
                    install: function() {
                        var a = this;
                        return a.isSetup() && !a.o && (g.report.subscribe(function() {
                            a.B.apply(a, arguments)
                        }), a.C(), a.l.instrument && a.l.instrument.tryCatch && a.D(), a.l.autoBreadcrumbs && a.E(), a.F(), a.o = !0), Error.stackTraceLimit = a.l.stackTraceLimit, this
                    },
                    setDSN: function(a) {
                        var b = this,
                            c = b.G(a),
                            ...
                            e = c.path.substr(1, d);
                        b.H = a, b.i = c.user, b.I = c.pass && c.pass.substr(1), b.j = c.path.substr(d + 1), b.h = b.J(c), b.K = b.h + "/" + e + "api/" + b.j + "/store/", this.z()
                    },
                    ...
                    uninstall: function() {
                        return g.report.uninstall(), this.P(), this.Q(), this.R(), Error.stackTraceLimit = this.p, this.o = !1, this
                    },
                    ...
                    captureMessage: function(a, b) {
                        if (!this.l.ignoreErrors.test || !this.l.ignoreErrors.test(a)) {
                            b = b || {};
                            var c, d = t({
                                message: a + ""
                            }, b);
                            ...
                            var f = g.computeStackTrace(c),
                                ...
                                i = h && h.url || "";
                            if ((!this.l.ignoreUrls.test || !this.l.ignoreUrls.test(i)) && (!this.l.whitelistUrls.test || this.l.whitelistUrls.test(i))) {
                                if (this.l.stacktrace || b && b.stacktrace) {
                                    b = t({
                                        fingerprint: a,
                    ...
                    captureBreadcrumb: function(a) {
                        ...
                        if (o(this.l.breadcrumbCallback)) {
                            var c = this.l.breadcrumbCallback(b);
                            if (l(c) && !r(c)) b = c;
                            else if (c === !1) return this
                        }
                        return this.v.push(b), this.v.length > this.l.maxBreadcrumbs && this.v.shift(), this
                    },
                    addPlugin: function(a) {
                        var b = [].slice.call(arguments, 1);
                        return this.s.push([a, b]), this.o && this.F(), this
                    },
                    setUserContext: function(a) {
                        return this.k.user = a, this
                    },
                    setExtraContext: function(a) {
                        return this.V("extra", a), this
                    },
                    setTagsContext: function(a) {
                        return this.V("tags", a), this
                    },
                    clearContext: function() {
                        return this.k = {}, this
                    },
                    getContext: function() {
                        return JSON.parse(h(this.k))
                    },
                    setEnvironment: function(a) {
                        return this.l.environment = a, this
                    },
                    setRelease: function(a) {
                        return this.l.release = a, this
                    },
                    setDataCallback: function(a) {
                        var b = this.l.dataCallback;
                        return this.l.dataCallback = e(b, a), this
                    },
                    setBreadcrumbCallback: function(a) {
                        var b = this.l.breadcrumbCallback;
                        return this.l.breadcrumbCallback = e(b, a), this
                    },
                    setShouldSendCallback: function(a) {
                        var b = this.l.shouldSendCallback;
                        return this.l.shouldSendCallback = e(b, a), this
                    },
                    setTransport: function(a) {
                        return this.l.transport = a, this
                    },
                    ...
                    isSetup: function() {
                        return !!this.b && (!!this.h || (this.ravenNotConfiguredError || (this.ravenNotConfiguredError = !0, this.A("error", "Error: Raven has not been configured.")), !1))
                    },
                    afterLoad: function() {
                        var a = J.RavenConfig;
                    ...
                    Z: function() {
                        ...
                        return function(c) {
                            ...
                            if (f && ("INPUT" === f || "TEXTAREA" === f || d.isContentEditable)) {
                                var g = a.Y;
                                g || a.X("input")(c), clearTimeout(g), a.Y = setTimeout(function() {
                                    a.Y = null
                                }, b)
                            }
                        }
                    ...
                    $: function(a, b) {
                        var c = D(this.x.href),
                            d = D(b),
                            e = D(a);
                        this.y = b, c.protocol === d.protocol && c.host === d.host && (b = d.relative), c.protocol === e.protocol && c.host === e.host && (a = e.relative), this.captureBreadcrumb({
                            category: "navigation",
                            data: {
                                to: b,
                                from: a
                    ...
                    C: function() {
                        var a = this;
                        a._ = Function.prototype.toString, Function.prototype.toString = function() {
                            return "function" == typeof this && this.M ? a._.apply(this.O, arguments) : a._.apply(this, arguments)
                        }
                    },
                    P: function() {
                        this._ && (Function.prototype.toString = this._)
                    },
                    D: function() {
                        function a(a) {
                            return function(b, d) {
                        ...
                        function b(a) {
                            ...
                            b && b.hasOwnProperty && b.hasOwnProperty("addEventListener") && (E(b, "addEventListener", function(b) {
                                return function(d, f, g, h) {
                                    ...
                                    var j, k, l;
                                    return e && e.dom && ("EventTarget" === a || "Node" === a) && (k = c.X("click"), l = c.Z(), j = function(a) {
                                        if (a) {
                                            var b;
                                            try {
                                                b = a.type
                    ...
                    E: function() {
                        ...
                        var b = this,
                            c = this.l.autoBreadcrumbs,
                            d = b.u;
                        if (c.xhr && "XMLHttpRequest" in J) {
                            var e = XMLHttpRequest.prototype;
                            E(e, "open", function(a) {
                                return function(c, d) {
                                    return p(d) && d.indexOf(b.i) === -1 && (this.aa = {
                                        method: c,
                                        url: d,
                                        status_code: null
                                ...
                                return function() {
                                    function d() {
                                        if (e.aa && 4 === e.readyState) {
                                            try {
                                                e.aa.status_code = e.status
                                            } catch (a) {}
                                            b.captureBreadcrumb({
                                                type: "http",
                                                category: "xhr",
                        ...
                        c.xhr && F() && E(J, "fetch", function(a) {
                            return function() {
                                ...
                                var e, f = c[0],
                                    g = "GET";
                                if ("string" == typeof f ? e = f : "Request" in J && f instanceof J.Request ? (e = f.url, f.method && (g = f.method)) : e = "" + f, e.indexOf(b.i) !== -1) return a.apply(this, c);
                        ...
                        }, d), c.dom && this.c && (K.addEventListener ? (K.addEventListener("click", b.X("click"), !1), K.addEventListener("keypress", b.Z(), !1)) : (K.attachEvent("onclick", b.X("click")), K.attachEvent("onkeypress", b.Z())));
                        var f = J.chrome,
                        ...
                        if (c.location && h) {
                            ...
                            J.onpopstate = function() {
                                var a = b.x.href;
                                if (b.$(b.y, a), i) return i.apply(this, arguments)
                            };
                            var j = function(a) {
                                return function() {
                                    var c = arguments.length > 2 ? arguments[2] : void 0;
                                    return c && b.$(b.y, c + ""), a.apply(this, arguments)
                                }
                            };
                    ...
                    R: function() {
                        for (var a in this.r) this.q[a] = this.r[a]
                    },
                    F: function() {
                        var a = this;
                        s(this.s, function(b, c) {
                            var d = c[0],
                                e = c[1];
                    ...
                    G: function(a) {
                        ...
                        if (c.pass && !this.l.allowSecretKey) throw new i("Do not specify your secret key in the DSN. See: http://bit.ly/raven-secret-key");
                        return c
                    },
                    J: function(a) {
                    ...
                    B: function() {
                        this.n || this.S.apply(this, arguments)
                    },
                    S: function(a, b) {
                        var c = this.T(a, b);
                        this.W("handle", {
                            stackInfo: a,
                            options: b
                        }), this.ba(a.name, a.message, a.url, a.lineno, c, b)
                    },
                    T: function(a, b) {
                        var c = this,
                            d = [];
                        ...
                        return d = d.slice(0, this.l.stackTraceLimit)
                    },
                    ca: function(a, b) {
                        var c = {
                            filename: a.url,
                        ...
                        return a.url || (c.filename = b), c.in_app = !(this.l.includePaths.test && !this.l.includePaths.test(c.filename) || /(Raven|TraceKit)\./.test(c["function"]) || /raven\.(min\.)?js$/.test(c.filename)), c
                    },
                    ba: function(a, b, c, d, e, f) {
                        var g = (a ? a + ": " : "") + (b || "");
                        if (!this.l.ignoreErrors.test || !this.l.ignoreErrors.test(b) && !this.l.ignoreErrors.test(g)) {
                            var h;
                            if (e && e.length ? (c = e[0].filename || c, e.reverse(), h = {
                                ...
                                }), (!this.l.ignoreUrls.test || !this.l.ignoreUrls.test(c)) && (!this.l.whitelistUrls.test || this.l.whitelistUrls.test(c))) {
                                var i = t({
                                    exception: {
                                        values: [{
                                            type: a,
                    ...
                    da: function(a) {
                        var b = this.l.maxMessageLength;
                        if (a.message && (a.message = u(a.message, b)), a.exception) {
                            var c = a.exception.values[0];
                            c.value = u(c.value, b)
                        }
                        var d = a.request;
                        return d && (d.url && (d.url = u(d.url, this.l.maxUrlLength)), d.Referer && (d.Referer = u(d.Referer, this.l.maxUrlLength))), a.breadcrumbs && a.breadcrumbs.values && this.ea(a.breadcrumbs), a
                    },
                    ea: function(a) {
                        for (var b, c, d, e = ["to", "from", "url"], f = 0; f < a.values.length; ++f)
                            if (c = a.values[f], c.hasOwnProperty("data") && l(c.data) && !v(c.data)) {
                                d = t({}, c.data);
                                for (var g = 0; g < e.length; ++g) b = e[g], d.hasOwnProperty(b) && d[b] && (d[b] = u(d[b], this.l.maxUrlLength));
                                a.values[f].data = d
                            }
                    },
                    fa: function() {
                        if (this.d || this.c) {
                            var a = {};
                            return this.d && L.userAgent && (a.headers = {
                                "User-Agent": navigator.userAgent
                            }), J.location && J.location.href && (a.url = J.location.href), this.c && K.referrer && (a.headers || (a.headers = {}), a.headers.Referer = K.referrer), a
                        }
                    },
                    z: function() {
                        this.ga = 0, this.ha = null
                    },
                    ia: function() {
                        return this.ga && d() - this.ha < this.ga
                    },
                    ja: function(a) {
                        var b = this.f;
                    ...
                    ka: function(a) {
                        if (!this.ia()) {
                            ...
                            if (400 === b || 401 === b || 429 === b) {
                                ...
                                this.ga = c ? c : 2 * this.ga || 1e3, this.ha = d()
                            }
                        }
                    },
                    U: function(a) {
                        var b = this.l,
                            ...
                            e = this.fa();
                        if (e && (c.request = e), a.trimHeadFrames && delete a.trimHeadFrames, a = t(c, a), a.tags = t(t({}, this.k.tags), a.tags), a.extra = t(t({}, this.k.extra), a.extra), a.extra["session:duration"] = d() - this.t, this.v && this.v.length > 0 && (a.breadcrumbs = {
                                values: [].slice.call(this.v, 0)
                            }), this.k.user && (a.user = this.k.user), b.environment && (a.environment = b.environment), b.release && (a.release = b.release), b.serverName && (a.server_name = b.serverName), Object.keys(a).forEach(function(b) {
                                (null == a[b] || "" === a[b] || r(a[b])) && delete a[b]
                            }), o(b.dataCallback) && (a = b.dataCallback(a) || a), a && !r(a) && (!o(b.shouldSendCallback) || b.shouldSendCallback(a))) return this.ia() ? void this.A("warn", "Raven dropped error due to backoff: ", a) : void("number" == typeof b.sampleRate ? Math.random() < b.sampleRate && this.la(a) : this.la(a))
                    },
                    ma: function() {
                        return z()
                    },
                    la: function(a, b) {
                        var c = this,
                            d = this.l;
                        if (this.isSetup()) {
                            if (a = this.da(a), !this.l.allowDuplicates && this.ja(a)) return void this.A("warn", "Raven dropped repeat event: ", a);
                            this.g = a.event_id || (a.event_id = this.ma()), this.f = a, this.A("debug", "Raven about to send:", a);
                            var e = {
                                sentry_version: "7",
                            ...
                            this.l.autoBreadcrumbs && this.l.autoBreadcrumbs.sentry && this.captureBreadcrumb({
                                category: "sentry",
                            ...
                            (d.transport || this.na).call(this, {
                                ...
                                onError: function(d) {
                                    c.A("error", "Raven transport failed to send: ", d), d.request && c.ka(d.request), c.W("failure", {
                                        data: a,
                                        src: g
                    ...
                    na: function(a) {
                        var b = a.url + "?" + y(a.auth),
                            c = null,
                            d = {};
                        if (a.options.headers && (c = this.oa(a.options.headers)), a.options.fetchParameters && (d = this.oa(a.options.fetchParameters)), F()) {
                            d.body = h(a.data);
                            var e = t({}, this.m),
                                f = t(e, d);
                    ...
                    A: function(a) {
                        this.r[a] && this.debug && Function.prototype.apply.call(this.r[a], this.q, [].slice.call(arguments, 1))
                    },
                    V: function(a, b) {
                        n(b) ? delete this.k[a] : this.k[a] = t(this.k[a] || {}, b)
                    }
